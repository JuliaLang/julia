...
@check_bit_operation (.^) Matrix{Complex{Uint8}} (Imaginary(0x0), b2)
@check_bit_operation (.^) Matrix{Complex{Uint8}} (Imaginary(0x1), b2)
...
@check_bit_operation (.^) Matrix{Complex64 } (b1, Imaginary(0x0))
...
@check_bit_operation (.^) Matrix{Complex128} (b1, 1im)
@check_bit_operation (.^) Matrix{Complex64 } (b1, Imaginary(0x1))
