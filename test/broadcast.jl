...
# make sure scalars are inlined as FusionConstants (generated by using Core.println)
#@test expand(Main, :(f.(x, y))) == Expr(:call, GlobalRef(Base, :broadcast), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:Fusion)), 2, false), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionCall)), :f, Expr(:call, GlobalRef(Core, :tuple), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 1)), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 2))))), :x, :y)
@test expand(Main, :(f.(x, y))) == Expr(:call, GlobalRef(Base, :broadcast), :f, :x, :y)

@test expand(Main, :(f.(x, 1))) == Expr(:call, GlobalRef(Base, :broadcast), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:Fusion)), 1, false), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionCall)), :f, Expr(:call, GlobalRef(Core, :tuple), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 1)), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionConstant)), 1)))), :x)

@test expand(Main, :(f.(x, 1.0))) == Expr(:call, GlobalRef(Base, :broadcast), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:Fusion)), 1, false), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionCall)), :f, Expr(:call, GlobalRef(Core, :tuple), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 1)), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionConstant)), 1.0)))), :x)

@test expand(Main, :(f.(x, $π))) == Expr(:call, GlobalRef(Base, :broadcast), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:Fusion)), 1, false), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionCall)), :f, Expr(:call, GlobalRef(Core, :tuple), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 1)), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionConstant)), π)))), :x)

@test expand(Main, :(f.(x, "hello"))) == Expr(:call, GlobalRef(Base, :broadcast), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:Fusion)), 1, false), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionCall)), :f, Expr(:call, GlobalRef(Core, :tuple), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 1)), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionConstant)), "hello")))), :x)

@test expand(Main, :(f.(x, $"hello"))) == Expr(:call, GlobalRef(Base, :broadcast), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:Fusion)), 1, false), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionCall)), :f, Expr(:call, GlobalRef(Core, :tuple), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 1)), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionConstant)), "hello")))), :x)

let val = QuoteNode(Any["some", "random", "splice", "value"])
    #@test expand(Main, :(f.(x, $val))) == Expr(:call, GlobalRef(Base, :broadcast), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:Fusion)), 2, false), Expr(:call, Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionCall)), :f, Expr(:call, GlobalRef(Core, :tuple), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 1)), Expr(:call, Expr(:call, GlobalRef(Core, :apply_type), Expr(:call, GlobalRef(Core, :getfield), GlobalRef(Base, :Broadcast), :(:FusionArg)), 2))))), :x, val)
    @test expand(Main, :(f.(x, $val))) == Expr(:call, GlobalRef(Base, :broadcast), :f, :x, val)
end
