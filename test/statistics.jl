...
@assert_approx_eq_eps ecdf(randn(10000000))([-1.96, -1.644854, -1.281552, -0.6744898, 0, 0.6744898, 1.281552, 1.644854, 1.96]) [0.025, 0.05, 0.1, 0.25, 0.5, 0.75, 0.9, 0.95, 0.975] 1e-4
@assert_approx_eq_eps ecdf(randn(10000000))(1.96) 0.975 1e-4
