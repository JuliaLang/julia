...
@test bincount([3, 1, 5, 2, 5, 3]) == Uint[1, 1, 2, 0, 2]
@test bincount([1, 2, 2], minlength=5) == Uint[1, 2, 0, 0, 0]
@test_fails bincount([2, -1, 3])
@test bincount([1, 1, 2, 2], weights=Float64[1.5, 3.2, 5.3, 1.2]) == Float64[4.7, 6.5]
