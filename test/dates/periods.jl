...
arr = [DateTime(2013, 11, 1, 10, 11, 12, 13),
       DateTime(2014, 12, 2, 20, 21, 22, 23)]
@test Dates.Year(arr) == [Dates.Year(2013), Dates.Year(2014)]
@test Dates.Month(arr) == [Dates.Month(11), Dates.Month(12)]
@test Dates.Week(arr) == [Dates.Week(44), Dates.Week(49)]
@test Dates.Day(arr) == [Dates.Day(1), Dates.Day(2)]
@test Dates.Hour(arr) == [Dates.Hour(10), Dates.Hour(20)]
@test Dates.Minute(arr) == [Dates.Minute(11), Dates.Minute(21)]
@test Dates.Second(arr) == [Dates.Second(12), Dates.Second(22)]
@test Dates.Millisecond(arr) == [Dates.Millisecond(13), Dates.Millisecond(23)]

arr = [10, 11]
@test Dates.Year(arr) == [Dates.Year(10), Dates.Year(11)]
@test Dates.Month(arr) == [Dates.Month(10), Dates.Month(11)]
@test Dates.Week(arr) == [Dates.Week(10), Dates.Week(11)]
@test Dates.Day(arr) == [Dates.Day(10), Dates.Day(11)]
@test Dates.Hour(arr) == [Dates.Hour(10), Dates.Hour(11)]
@test Dates.Minute(arr) == [Dates.Minute(10), Dates.Minute(11)]
@test Dates.Second(arr) == [Dates.Second(10), Dates.Second(11)]
@test Dates.Millisecond(arr) == [Dates.Millisecond(10), Dates.Millisecond(11)]
