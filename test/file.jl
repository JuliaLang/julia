...
@testset "checkfor_mv_cp_cptree - overwrite checks" begin
    mktempdir() do dir
        ...
        @test_throws ArgumentError Filesystem.checkfor_mv_cp_cptree(dst, dst, "test"; force=false)

        # Case 2: dst exists, force=true, src == dst
        @test_throws ArgumentError Filesystem.checkfor_mv_cp_cptree(dst, dst, "test"; force=true)
    end
end
