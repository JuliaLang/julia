...
; CHECK-LABEL: @field_write_barrier_loaded_ok
define void @field_write_barrier_loaded_ok(ptr addrspace(10) %parent, ptr addrspace(13) %slot, ptr addrspace(10) %child) {
  call void (ptr addrspace(10), ptr addrspace(13), ptr addrspace(10), ...) @julia.field_write_barrier.p13(ptr addrspace(10) %parent, ptr addrspace(13) %slot, ptr addrspace(10) %child, ptr addrspace(13) %slot, ptr addrspace(10) null)
  ret void
}
