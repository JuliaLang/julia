...
; RUN: opt -enable-new-pm=0  --target=x86_64 -march=znver2 -load libjulia-codegen%shlibext -DemoteFloat16 -S %s | FileCheck %s
; RUN: opt -enable-new-pm=1  --target=x86_64 -march=znver2--load-pass-plugin=libjulia-codegen%shlibext -passes='DemoteFloat16' -S %s | FileCheck %s
