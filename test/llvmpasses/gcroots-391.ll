...
; This file has test cases for IR only valid on LLVM 3.9.1/4.0
...
Abody:
    %aarg = bitcast %jl_value_t addrspace(10)** %jlcall.sub to i8*
    call void @llvm.lifetime.start(i64 16, i8* %aarg)
    ...
    call void @llvm.lifetime.end(i64 16, i8* %aarg)
...
B:
    ...
    %aarg2 = bitcast %jl_value_t addrspace(10)** %jlcall.sub to i8*
    call void @llvm.lifetime.start(i64 16, i8* %aarg2)
    ...
    call %jl_value_t addrspace(10)* @jl_apply_generic(%jl_value_t addrspace(10)* null, %jl_value_t addrspace(10)** %jlcall.sub, i32 2)
    call void @llvm.lifetime.end(i64 16, i8* %aarg2)
    br i1 undef, label %loop, label %out
out:
    ret void
}
...
; CHECK-NOT: call void @llvm.lifetime.start
    ...
    %aarg = bitcast %jl_value_t addrspace(10)** %jlcall to i8*
    call void @llvm.lifetime.start(i64 16, i8* %aarg)
