...
; Without proper attributes on throw functions, AA is conservative about what
; they might read, which can block sinking. Here we add nocapture readonly
; to let AA know throw_error1 only reads %tuple1 and throw_error2 only reads %tuple2.
