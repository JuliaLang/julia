...
;   - comma-separated lists fold to true only when every feature is enabled.
...
; A comma-separated list requires every feature.
; CHECK-LABEL: @list_all_enabled
; CHECK-NOT: julia.cpu.supports
; CHECK: call i32 @sink_true
define i32 @list_all_enabled() #1 {
  %v = call i1 @"julia.cpu.supports.avx2,fma,sse4.2"()
  br i1 %v, label %T, label %F
T:
  %r1 = call i32 @sink_true()
  ret i32 %r1
...
; CHECK-LABEL: @list_one_missing
; CHECK-NOT: julia.cpu.supports
; CHECK: call i32 @sink_false
define i32 @list_one_missing() #4 {
  %v = call i1 @"julia.cpu.supports.avx2,avx512f"()
  br i1 %v, label %T, label %F
T:
  %r1 = call i32 @sink_true()
  ret i32 %r1
...
; CHECK-LABEL: @list_one_unknown
; CHECK-NOT: julia.cpu.supports
; CHECK: call i32 @sink_false
define i32 @list_one_unknown() #1 {
  %v = call i1 @"julia.cpu.supports.avx2,totally_made_up_feature"()
  br i1 %v, label %T, label %F
T:
  %r1 = call i32 @sink_true()
  ret i32 %r1
...
declare i1 @"julia.cpu.supports.avx2,fma,sse4.2"()
declare i1 @"julia.cpu.supports.avx2,avx512f"()
declare i1 @"julia.cpu.supports.avx2,totally_made_up_feature"()
