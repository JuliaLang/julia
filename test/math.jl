...
@test_throws airy(200im) Base.Math.AmosException
@test_throws airybi(200) Base.Math.AmosException
...
@test_approx_eq besselh(-3,2,3) -conj(true_h133)
@test_throws besselh(1,0) Base.Math.AmosException
...
@test_approx_eq besseli(3,-3) -true_i33
@test_approx_eq besseli(-3,-3) -true_i33
@test_throws besseli(1,1000) Base.Math.AmosException
...
@test_throws besselj(20,1000im) Base.Math.AmosException
...
@test_approx_eq besselk(-3,complex(-3)) true_k3m3
@test_throws besselk(200,0.01) Base.Math.AmosException
...
@test_throws bessely(200.5,0.1) Base.Math.AmosException
