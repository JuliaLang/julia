...
temp_pkg_dir() do
    ...
    let branch_name = "test-branch-1",
        ...
        @test LibGit2.head_oid(LibGit2.GitRepo(Pkg.dir("Example2"))) == LibGit2.GitHash(branch_commit)
        @test LibGit2.head_oid(LibGit2.GitRepo(Pkg.dir("Example3"))) == LibGit2.GitHash(branch_commit)
    end
    ...
    let branch_name = "test-branch-2",
        ...
        # create a branch in Example package
        LibGit2.branch!(LibGit2.GitRepo(Pkg.dir("Example")), branch_name, branch_commit, set_head=true)
