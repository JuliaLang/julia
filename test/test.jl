...
struct NoThrowTestSet <: Base.Test.AbstractTestSet
    results::Vector
...
const struct CustomTestSet <: Base.Test.AbstractTestSet
...
const struct SillyArray <: AbstractArray{Float64,1} end
