...
@test Which_test.test1(1.0) == Tuple{Real,}
@test Which_test.test1(123) == Tuple{Int}
...
@test Which_test.test3(1, Any[1.0, 2.0]) == Tuple{Int, Vararg{Real}}
...
i1 = 1
x7 = 7
@test Which_test.test4(t4, i1) == "Tuple{Tuple,$Int}"
@test Which_test.test5(t4, i1) == "Tuple{Tuple,$Int}"
@test Which_test.test4(a4, i1) == "Tuple{Array{T,N},Real}"   # yes, Real.  Why?
@test Which_test.test5(a4, i1) == "Tuple{Array{T,N},Real}"
@test Which_test.test6(a4, i1, x7) == "Tuple{Array{Any,N},ANY,Real}"
@test Which_test.test7(a4, i1, x7) == "Tuple{Array{Any,N},ANY,Real}"
