...
@testset "boundscheck elimination" begin
...
# TODO: These work in the REPL but not in make -C test compiler/llvmpipeline?
@testset "zeroinit" begin
...
@testset "basic-loops" begin
    ...
    # TODO: This works in the REPL but not in make -C test compiler/llvmpipeline?
