...
@test sprint(varinfo, Main, r"^$") == ""
let v = sprint(varinfo, _test_varinfo_)
...
varinfo(IOBuffer(), Tmp14173) # warm up
const MEMDEBUG = ccall(:jl_is_memdebug, Bool, ())
@test @allocated(varinfo(IOBuffer(), Tmp14173)) < (MEMDEBUG ? 30000 : 10000)
