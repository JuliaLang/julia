...
@test Base.prettyprint_getunits(Int64(1024)^5 - 1, 6, 1024)[2] == 5
@test Base.prettyprint_getunits(Int64(1024)^5, 6, 1024) == (1, 6)
@test Base.prettyprint_getunits(Int64(1024)^5 + 1, 6, 1024)[2] == 6
@test Base.prettyprint_getunits(Int64(1024)^5, 5, 1024) == (1024, 5)
