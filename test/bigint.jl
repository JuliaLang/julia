...
@test foldl(xor, (a, b)) == parse(BigInt,"327299")
@test foldl(xor, (a, b, c)) == parse(BigInt,"3426495623485904783798472")
@test foldl(xor, (a, b, c, d)) == parse(BigInt,"-3426495623485906178489610")
@test foldl(xor, (a, b, c, d, f)) == parse(BigInt,"-2413804710837418037418307081437316711364709261074607933698")
@test foldl(xor, (a, b, c, d, f, g)) == parse(BigInt,"2413804710837418037418307081437316711364709261074607933697")

@test foldl(&, (a, b)) == parse(BigInt,"124")
@test foldl(&, (a, b, c)) == parse(BigInt,"72")
@test foldl(&, (a, b, c, d)) == parse(BigInt,"8")
@test foldl(&, (a, b, c, d, f)) == parse(BigInt,"8")
@test foldl(&, (a, b, c, d, f, g)) == parse(BigInt,"8")

@test foldl(|, (a, b)) == parse(BigInt,"327423")
@test foldl(|, (a, b, c)) == parse(BigInt,"3426495623485904783802111")
@test foldl(|, (a, b, c, d)) == parse(BigInt,"-1396834561")
@test foldl(|, (a, b, c, d, f)) == parse(BigInt,"-1358954753")
@test foldl(|, (a, b, c, d, f, g)) == parse(BigInt,"-1")
