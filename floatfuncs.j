...
exponent(x::Float64) = ccall(dlsym(JuliaDLHandle,"double_exponent"), Int32, (Float64,), x)
exponent(x::Float32) = ccall(dlsym(JuliaDLHandle,"float_exponent"),  Int32, (Float32,), x)
mantissa(x::Float64) = ccall(dlsym(JuliaDLHandle,"double_mantissa"), Float64, (Float64,), x)
mantissa(x::Float32) = ccall(dlsym(JuliaDLHandle,"float_mantissa"),  Float32, (Float32,), x)
