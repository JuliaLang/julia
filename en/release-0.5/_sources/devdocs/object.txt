...
Mirror structs for some of the built-in types are `defined in julia.h <https://github.com/JuliaLang/julia/blob/release-0.5/src/julia.h>`_.
The corresponding global :c:type:`jl_datatype_t` objects are created by `jl_init_types in jltypes.c <https://github.com/JuliaLang/julia/blob/release-0.5/src/jltypes.c>`_.
...
which you can find declared in `julia.h <https://github.com/JuliaLang/julia/blob/release-0.5/src/julia.h>`_.
