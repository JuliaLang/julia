...
========================== ==================================  =================
:func:`round(x) <round>`   round ``x`` to the nearest integer  ``FloatingPoint``
:func:`iround(x) <iround>` round ``x`` to the nearest integer  ``Integer``
:func:`floor(x) <floor>`   round ``x`` towards ``-Inf``        ``FloatingPoint``
:func:`ifloor(x) <ifloor>` round ``x`` towards ``-Inf``        ``Integer``
:func:`ceil(x) <ceil>`     round ``x`` towards ``+Inf``        ``FloatingPoint``
:func:`iceil(x) <iceil>`   round ``x`` towards ``+Inf``        ``Integer``
:func:`trunc(x) <trunc>`   round ``x`` towards zero            ``FloatingPoint``
:func:`itrunc(x) <itrunc>` round ``x`` towards zero            ``Integer``
========================== ==================================  =================
