@enum(Kind,
    ...
    begin_keywords,
        ...
        end_0arg_kw,
        begin_1arg_kw,
            ABSTRACT, CONST, EXPORT, GLOBAL, LOCAL, IMPORT, IMPORTALL, RETURN, USING, WHERE,
        end_1arg_kw,
        begin_2arg_kw,
            BITSTYPE, PRIMITIVE, TYPEALIAS,
        end_2arg_kw,
        BEGIN, QUOTE,
        begin_3arg_kw,
            BAREMODULE, DO, FOR, FUNCTION, IMMUTABLE, LET, MACRO, MUTABLE, MODULE, STRUCT, TYPE, WHILE,
        end_3arg_kw,
        IF, ELSEIF, ELSE,
        TRY, CATCH, FINALLY,
        END,  
