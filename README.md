...
- **[which]**                   - needed by Make
- **[openssl]**                 - needed by Make
- **[bzip2]**                   - needed to build dependencies
- **[openssl-devel]**           - needed to build dependencies (libgit2)
