...
Julia is a very high level dynamic language for numerical and scientific computing.
It strives to provide a high performance compiler, massive parallelism, and numerical accuracy.
Some features include optional typing, multiple dispatch, and good performance through type inference and just-in-time (JIT) compilation.
