...
Julia beats other high-level systems on all benchmarks.
It comes within a factor of two of heavily optimized, well-written C++ on all but two tests, and is never more than four times as slow.
