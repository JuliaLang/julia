...
1. Before opening a new [Github issue](https://github.com/JuliaLang/julia/issues), try searching the existing issues or the [`julia-users` mailing list](https://groups.google.com/forum/#!forum/julia-users) to see if someone else has already noticed the same problem.
...
3. For segfaults or other hard crashes:
