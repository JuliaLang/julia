...
f41438(y) = y[].x
@test A41438.inner.layout != C_NULL
@test B41438.inner.layout === C_NULL
...
@test S41438.inner.layout != C_NULL
@test !Base.datatype_pointerfree(S41438.inner)
...
@test A43303.inner.layout != C_NULL
@test isbitstype(A43303{Int})
@test A43303.inner.types[1].layout != C_NULL
