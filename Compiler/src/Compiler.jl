...
# when true, inference may assume method-table completeness even for callees marked
# `Base.Experimental.@extension_point` (the historical behavior); see `world_splitting_enabled`
