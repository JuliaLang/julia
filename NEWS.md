...
* The REPL now provides syntax highlighting for input as you type. This can be disabled by setting `repl.options.style_input = false` in your startup file. See the REPL docs for more info about customization.
