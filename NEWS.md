...
----------------
  ...
  * The default color for info messages has been changed from blue to cyan.
    ...
    For more information regarding customizing colors in the REPL, see this [manual section]( http://docs.julialang.org/en/release-0.5/manual/interacting-with-julia/#customizing-colors).
