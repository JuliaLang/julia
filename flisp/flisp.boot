(*banner* ";  _\n; |_ _ _ |_ _ |  . _ _\n; | (-||||_(_)|__|_)|_)\n;-------------------|----------------------------------------------------------\n\n"
	  *interactive* #f *syntax-environment*
	  #table(letrec #fn(">000s1c0c1L1e2c3|32L1e2c4|32c5}3134e2c6|32K;" [#builtin(nconc)
  lambda map #.car #fn("8000r1c0c1|31K;" [set! #builtin(copy-list)])
  #builtin(copy-list) #fn("6000r1e040;" [void])])  quasiquote #fn("7000r1e0|41;" [bq-process])  when #fn("<000s1c0|c1}K^L4;" [if
  begin])  dotimes #fn(";000s1c0q|M|\x8442;" [#fn("=000r2c0`c1}aL3c2c3L1|L1L1c4\x7f3133L4;" [for
  - #builtin(nconc) lambda #builtin(copy-list)])])  unwind-protect #fn("8000r2c0qc130c13042;" [#fn("@000r2c0}c1_\x7fL3L2L1c2c3~c1|L1c4}L1c5|L2L3L3L3}L1L3L3;" [let
  ...
  begin])  let* #fn("A000s1|?6E0c0c1L1_L1c2}3133L1;c0c1L1e3|31L1L1c2|NF6H0c0c4L1|NL1c2}3133L1530}3133e5|31L2;" [#builtin(nconc)
  ...
  #builtin(gensym)])])  catch #fn("7000r2c0qc13041;" [#fn("@000r1c0\x7fc1|L1c2c3c4|L2c5c6|L2c7c8L2L3c5c9|L2~L3L4c:|L2c;|L2L4L3L3;" [trycatch
  lambda if and pair? eq car quote thrown-value cadr caddr raise])
						      #builtin(gensym)])  assert #fn("<000r1c0|]c1c2c3|L2L2L2L4;" [if
  ...
  #builtin(gensym) map #.car cadr #fn("7000r1e0|31F680e1|41;|M;" [cddr caddr])])  with-input-from #fn("=000s1c0c1L1c2|L2L1L1c3}3143;" [#builtin(nconc)
  with-bindings *input-stream* #builtin(copy-list)])  let #fn(":000s1c0q^41;" [#fn("<000r1~C6D0~m02\x7fMo002\x7fNo01530]2c0qc1c2L1e3c4~32L1c5\x7f3133e3c6~3242;" [#fn("8000r2~6;0c0~|L3530|}K;" [label])
  ...
  if caddr]) #builtin(gensym) if])] cond-clauses->if)])])  throw #fn(":000r2c0c1c2c3L2|}L4L2;" [raise
  ...
  with-bindings *output-stream* #builtin(copy-list)])  with-bindings #fn(">000s1c0qe1c2|32e1e3|32e1c4|3243;" [#fn("A000r3c0c1L1e2c3g2|33L1c4e2c5|}3331c6c7c4\x7f31Kc7c4e2c8|g23331KL3L144;" [#builtin(nconc)
  let map #.list #builtin(copy-list) #fn("8000r2c0|}L3;" [set!]) unwind-protect
  begin #fn("8000r2c0|}L3;" [set!])]) map #.car cadr #fn("6000r1c040;" [#builtin(gensym)])]))
	  *whitespace* "\t\n\v\f\r \u0085  ᠎           \u2028\u2029  　" 1+
  ...
  *argv* *interactive* __script princ *banner* repl #builtin(exit)] __start)
	  ...
	  #fn("7000r1|a[;" [] bcode:ctable) bcode:indexfor #fn("9000r2c0qe1|31e2|3142;" [#fn(":000r2c0|\x7f32690c1|\x7f42;c2|\x7f}332}~b2}aw\\2;" [#builtin(has?)
  #builtin(get) #builtin(put!)]) bcode:ctable bcode:nconst] bcode:indexfor)
  ...
  ()])
	  ...
	  #fn("6000r1|NN;" [] cddr) char? #fn("7000r1c0|31c1<;" [#builtin(typeof)
								 wchar] char?)
  ...
  in-env? #builtin(top-level-value) length= compile-in emit #fn("=000r1~6H0e0i30i31i32i33i10~|47;e1i30i32670c2540c3|43;" [compile-builtin-call
  emit tcall call]) compile-arglist]) builtin->instruction]) in-env? #builtin(constant?)
  #builtin(top-level-value)])] compile-app)
	  compile-arglist #fn("8000r3e0c1qg2322c2g241;" [for-each #fn(":000r1e0~\x7f^|44;" [compile-in])
							 #builtin(length)] compile-arglist)
  ...
  bcode:cdepth nnn #builtin(constant?) printable? #builtin(top-level-value)
  loadv]) lookup-sym] compile-sym)
	  compile-thunk #fn(";000r1e0c1c2L1_L1|L1~3441;" [compile #builtin(nconc)
							  lambda] #0#)
  ...
  255]) #builtin(assq) ((loadv loadv.l) (loadg loadg.l) (setg setg.l) (loada
  loada.l)
					(seta seta.l))
  ...
  emit-optional-arg-inits]) make-label] emit-optional-arg-inits)
	  encode-byte-code #fn("8000r1c0e1|3141;" [#fn("8000r1c0e1|3141;" [#fn(";000r1c0qe1c2|31b3c2|31b2VT2wc33241;" [#fn("=000r1c0qc1~31`c230c230c330^^47;" [#fn("?000r7c0g4c1322]}|X6\xff02i10}[m52g5c2\x82O0c3g2i10}aw[c4g431332}b2wm15\xcf0c0g4e5c6e7~6<0c8qg531540g53231322}awm12}|X6:0i10}[530^m62c9g5c:326^0c3g3c4g431g6332c0g4~670e;540e<`31322}awm15_0g5c=\x82G0c0g4e;g631322}awm15C0g6D6<0c>qg531530^5_/2e?c@qg3322cAg441;" [#builtin(io.write)
  #int32(0) label #builtin(put!) #builtin(sizeof) byte #builtin(get)
  Instructions #fn("7000r1|c0\x8250c1;|c2\x8250c3;|c4\x8250c5;|c6\x8250c7;|c8\x8250c9;|c:\x8250c;;i05;" [jmp
  jmp.l brt brt.l brf brf.l brne brne.l brnn brnn.l brn brn.l])
  #builtin(memq) (jmp brf brt brne brnn brn) int32 int16 brbound #fn(":000r1c0|c1326H0c2i04e3i0631322\x7fawo01;c0|c4326`0c2i04e5i0631322\x7fawo012c2i04e5i20\x7f[31322\x7fawo01;c0|c6326\x820c2i04e3i0631322\x7fawo012c2i04e3i20\x7f[31322\x7fawo012i05c7\x82J0c2i04e3i20\x7f[31322\x7fawo01;];c2i04e5i0631322\x7fawo01;" [#builtin(memq)
  (loadv.l loadg.l setg.l loada.l seta.l largc lvargc call.l tcall.l)
  #builtin(io.write) int32 (loadc setc) uint8 (loadc.l setc.l optargs keyargs)
  keyargs]) table.foreach #fn("<000r2c0i04|322c1i04i10670e2540e3c4i02}32|x3142;" [#builtin(io.seek)
  #builtin(io.write) int32 int16 #builtin(get)])
  #builtin(io.tostring!)]) #builtin(length)
  #builtin(table) #builtin(buffer)]) >= #builtin(length) 65536]) list->vector])
						   reverse!] encode-byte-code)
	  error #fn(":000s0c0c1|K41;" [#builtin(raise) error] error) eval
	  #fn("8000r1e0e1|313140;" [compile-thunk expand] eval) even? #fn("8000r1c0|a32`W;" [#builtin(logand)] even?)
  ...
  #builtin(nconc) lambda #builtin(copy-list)]) cddr void error "compile error: invalid syntax "
  ...
  caadr begin #builtin(nconc) map] #1#) ()])
	  ...
	  #fn("8000r2}F16F02c0|}M3217:02e1|}N42;" [#builtin(memq) in-env?] in-env?)
	  index-of #fn(":000r3}\x8540^;|}M\x8250g2;e0|}Ng2aw43;" [index-of] index-of)
	  io.readall #fn("7000r1c0qc13041;" [#fn("8000r1c0|~322c1qc2|3141;" [#builtin(io.copy)
  #fn("7000r1|c0>16:02c1i1031670c240;|;" ["" #builtin(io.eof?)
					  #builtin(eof-object)])
  #builtin(io.tostring!)]) #builtin(buffer)] io.readall)
	  io.readline #fn("8000r1c0|c142;" [#builtin(io.readuntil)
	  ...
	  #fn("9000r1c0|316@0c1c2c3|313141;|;" [#builtin(keyword?)
						#builtin(symbol)
						#fn("<000r1c0|`c1|c2|313243;" [#builtin(string.sub)
  #builtin(string.dec) #builtin(length)])
						#builtin(string)] keyword->symbol)
	  keyword-arg? #fn("7000r1|F16902c0|M41;" [#builtin(keyword?)] keyword-arg?)
  ...
  " in list " #builtin(keyword?) ". keyword arguments must come last."
  ...
  to-proper])] lambda-vars)
	  ...
	  load #fn("9000r1c0qc1|c23241;" [#fn("7000r1c0qc1qt;" [#fn("9000r0c0q^31]]]43;" [#fn("6000r1c0qm0;" [#fn(":000r3c0i10317C0~c1i1031|e2}3143;c3i10312e2}41;" [#builtin(io.eof?)
  #builtin(read) load-process #builtin(io.close)])])])
								#fn("9000r1c0~312c1c2i10|L341;" [#builtin(io.close)
  #builtin(raise) load-error])]) #builtin(file) :read] load)
  ...
  index-of])] lookup-sym)
	  ...
	  make-code-emitter #fn("9000r0_c030`c1Z4;" [#builtin(table) +inf.0] make-code-emitter)
	  make-label #fn("6000r1c040;" [#builtin(gensym)] make-label)
  ...
  *print-readably* #fn("7000r1c0qc1qt|302;" [#fn(":000r0c0qe1c2qe3c4303132312c5i2041;" [#fn("=000r1c0c1e2c3|e2c4|3233Q2i20322c5i20e642;" [#builtin(write)
  ...
  #builtin(io.close)]) #fn("7000r1~302c0|41;" [#builtin(raise)])])
  #fn("6000r0~k02\x7fk1;" [*print-pretty* *print-readably*])]) *print-pretty*
  *print-readably*]) #builtin(file) :write :create :truncate (*linefeed*
							      *directory-separator*
							      *argv* that
							      *print-pretty*
							      *print-width*
	  ...
	  map #fn("=000s2g2\x85H0|G6<0e0|}_L143;c1|}42;e2|}g2K42;" [map1-other
								    #builtin(map1)
								    mapn] map)
	  ...
	  map-other #fn("9000r3g2]}F6H02g2|}M31_KPNm22}Nm15\x17/2N;" [] map-other)
	  map1-other #fn("9000r3g2]}F6H02g2|}M31_KPNm22}Nm15\x17/2N;" [] map1-other)
	  mapn #fn(";000r2}M\x8540_;|c0c1}32Q2e2|c0c3}3232K;" [#builtin(map1)
							       #fn("6000r1|M;" [])
							       mapn #fn("6000r1|N;" [])] mapn)
  ...
  #fn("7000r2|}X640|;};" [])] min)
	  ...
	  #fn("8000r2c0e1|31}42;" [#builtin(nconc) reverse!] nreconc) odd? #fn("7000r1e0|31@;" [even?] odd?)
  ...
  #builtin(write)]) #fn("7000r1~302c0|41;" [#builtin(raise)])])
							   #fn("6000r0~k0;" [*print-readably*])])
				*print-readably*] princ)
	  print #fn(":000s0e0c1|42;" [for-each #builtin(write)] print)
  ...
  #builtin(io.tostring!)]) #builtin(buffer)] print-to-string)
	  printable? #fn("7000r1c0|3117802c1|31@;" [#builtin(iostream?)
						    #builtin(eof-object?)] printable?)
	  quote-value #fn("7000r1e0|31640|;c1|L2;" [self-evaluating? quote] quote-value)
	  random #fn("8000r1c0|316<0e1c230|42;c330|T2;" [#builtin(integer?) mod
							 #builtin(rand)
							 #builtin(rand.double)] random)
	  read-all #fn("8000r1e0c1|42;" [read-all-of #builtin(read)] read-all)
	  read-all-of #fn("9000r2c0q^31_|}3142;" [#fn("6000r1c0qm0;" [#fn("9000r2c0i1131680e1|41;~}|Ki10i113142;" [#builtin(io.eof?)
  reverse!])])] read-all-of)
	  ref-int16-LE #fn(";000r2e0c1|}`w[`32c1|}aw[b832w41;" [int16 #builtin(ash)] ref-int16-LE)
	  ref-int32-LE #fn("=000r2e0c1|}`w[`32c1|}aw[b832c1|}b2w[b@32c1|}b3w[bH32R441;" [int32
  #builtin(ash)] ref-int32-LE)
	  repl #fn("8000r0c0]]42;" [#fn("6000r2c0m02c1qm12}302e240;" [#fn("8000r0e0c1312c2e3312c4c5c6t41;" [princ
  "> " #builtin(io.flush) *output-stream* #fn("8000r1c0e131@16<02c2e3|3141;" [#builtin(io.eof?)
  *input-stream* #fn("7000r1e0|312|k12];" [print that]) load-process])
  #fn("6000r0c040;" [#builtin(read)]) #fn("7000r1c0e1312c2|41;" [#builtin(io.discardbuffer)
								 *input-stream*
								 #builtin(raise)])] prompt)
  #fn("7000r0c0qc1t6;0e2302\x7f40;^;" [#fn("7000r0~3016702e040;" [newline])
	  ...
	  revappend #fn("8000r2c0e1|31}42;" [#builtin(nconc) reverse] revappend)
  ...
  #fn(":000r2c0e1|31~L1e1}3143;" [#builtin(nconc) simple-sort])])] simple-sort)
	  string.join #fn("7000r2|\x8550c0;c1qc23041;" ["" #fn("8000r1c0|~M322e1c2q~N322c3|41;" [#builtin(io.write)
  for-each #fn("8000r1c0~i11322c0~|42;" [#builtin(io.write)])
  #builtin(io.tostring!)]) #builtin(buffer)] string.join)
	  string.lpad #fn(";000r3c0e1g2}c2|31x32|42;" [#builtin(string)
						       string.rep #builtin(string.count)] string.lpad)
	  string.map #fn("9000r2c0qc130c2}3142;" [#fn("7000r2c0q`312c1|41;" [#fn(";000r1]|\x7fX6S02c0~i10c1i11|3231322c2i11|32m05\v/;" [#builtin(io.putc)
  #builtin(string.char) #builtin(string.inc)])
  #builtin(io.tostring!)]) #builtin(buffer)
						  #builtin(length)] string.map)
	  string.rep #fn(";000r2}b4X6`0e0}`32650c1;}aW680c2|41;}b2W690c2||42;c2|||43;e3}316@0c2|e4|}ax3242;e4c2||32}b2U242;" [<=
  "" #builtin(string) odd? string.rep] string.rep)
	  string.rpad #fn("<000r3c0|e1g2}c2|31x3242;" [#builtin(string)
						       string.rep #builtin(string.count)] string.rpad)
	  string.tail #fn(";000r2c0|c1|`}3342;" [#builtin(string.sub)
						 #builtin(string.inc)] string.tail)
	  string.trim #fn("8000r3c0q]]42;" [#fn("8000r2c0qm02c1qm12c2qc3~3141;" [#fn(";000r4g2g3X16?02c0}c1|g232326A0~|}c2|g232g344;g2;" [#builtin(string.find)
  #builtin(string.char) #builtin(string.inc)] trim-start)
  #fn("<000r3e0g2`3216D02c1}c2|c3|g23232326?0\x7f|}c3|g23243;g2;" [> #builtin(string.find)
								   #builtin(string.char)
								   #builtin(string.dec)] trim-end)
  #fn("<000r1c0i10~i10i11`|34\x7fi10i12|3343;" [#builtin(string.sub)])
  ...
  #fn("9000r3c0~}|43;" [#builtin(put!)])])
	  ...
	  table.values #fn("9000r1c0c1_|43;" [#builtin(table.foldl)
  ...
  *output-stream* #fn("7000r1c0qc1qt|302;" [#fn("7000r0e0i20312e1c23041;" [print-exception
  ...
  #builtin(vector.alloc)]) #builtin(length)] vector.map)
