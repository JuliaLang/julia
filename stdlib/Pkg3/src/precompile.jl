...
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Array{Any, 1}, Array{Array{String, 1}, 1}, Base.Dict{String, Base.VersionNumber}, Array{Any, 1}}, Int64, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Base.UUID, Base.VersionNumber}, Int64, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Expr, Int64}, Int64, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Pkg3.Types.PackageSpec, Bool, String}, Int64, Int64})
precompile(Tuple{typeof(Base.indexed_iterate), Tuple{Pkg3.Types.PackageSpec, String}, Int64, Int64})
