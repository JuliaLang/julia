...
@testset "adjoint and transpose MemoryLayout" begin
    A = [1.0 2; 3 4]
    @test LinearAlgebra.MemoryLayout(A') == LinearAlgebra.DenseRowMajor{Float64}()
    @test LinearAlgebra.MemoryLayout(transpose(A)) == LinearAlgebra.DenseRowMajor{Float64}()
    B = [1.0+im 2; 3 4]
    @test LinearAlgebra.MemoryLayout(B') == LinearAlgebra.ConjLayout(LinearAlgebra.DenseRowMajor{ComplexF64}())
    @test LinearAlgebra.MemoryLayout(transpose(B)) == LinearAlgebra.DenseRowMajor{ComplexF64}()
    VA = view(A, 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VA') == LinearAlgebra.DenseRowsStridedColumns{Float64}()
    @test LinearAlgebra.MemoryLayout(transpose(VA)) == LinearAlgebra.DenseRowsStridedColumns{Float64}()
    VB = view(B, 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VB') == LinearAlgebra.ConjLayout(LinearAlgebra.DenseRowsStridedColumns{ComplexF64}())
    @test LinearAlgebra.MemoryLayout(transpose(VB)) == LinearAlgebra.DenseRowsStridedColumns{ComplexF64}()
    VA = view(A, 1:2:2, 1:2:2)
    @test LinearAlgebra.MemoryLayout(VA') == LinearAlgebra.StridedLayout{Float64}()
    @test LinearAlgebra.MemoryLayout(transpose(VA)) == LinearAlgebra.StridedLayout{Float64}()
    VB = view(B, 1:2:2, 1:2:2)
    @test LinearAlgebra.MemoryLayout(VB') == LinearAlgebra.ConjLayout(LinearAlgebra.StridedLayout{ComplexF64}())
    @test LinearAlgebra.MemoryLayout(transpose(VB)) == LinearAlgebra.StridedLayout{ComplexF64}()
    VA2 = view(A, [1,2], :)
    ...
    VAc = view(A', 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VAc) == LinearAlgebra.DenseRowsStridedColumns{Float64}()
    VAt = view(transpose(A), 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VAt) == LinearAlgebra.DenseRowsStridedColumns{Float64}()
    VBc = view(B', 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VBc) == LinearAlgebra.ConjLayout(LinearAlgebra.DenseRowsStridedColumns{ComplexF64}())
    VBt = view(transpose(B), 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VBt) == LinearAlgebra.DenseRowsStridedColumns{ComplexF64}()
end
