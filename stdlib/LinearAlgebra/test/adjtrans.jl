...
@testset "adjoint and transpose MemoryLayout" begin
    ...
    B = [1.0+im 2; 3 4]
    @test LinearAlgebra.MemoryLayout(B') == LinearAlgebra.ConjDenseRowMajor{ComplexF64}()
    ...
    VB = view(B, 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VB') == LinearAlgebra.ConjDenseRowsStridedColumns{ComplexF64}()
    ...
    @test LinearAlgebra.MemoryLayout(VB') == LinearAlgebra.ConjStridedLayout{ComplexF64}()
    ...
    VBc = view(B', 1:1, 1:1)
    @test LinearAlgebra.MemoryLayout(VBc) == LinearAlgebra.ConjDenseRowsStridedColumns{ComplexF64}()
