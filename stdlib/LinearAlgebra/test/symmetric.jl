...
@testset "Symmetric/Hermitian MemoryLayout" begin
    A = [1.0 2; 3 4]
    @test Base.MemoryLayout(Symmetric(A)) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{Float64}(),'U')
    @test Base.MemoryLayout(Hermitian(A)) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{Float64}(),'U')
    @test Base.MemoryLayout(Transpose(Symmetric(A))) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{Float64}(),'U')
    @test Base.MemoryLayout(Transpose(Hermitian(A))) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{Float64}(),'U')
    @test Base.MemoryLayout(Adjoint(Symmetric(A))) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{Float64}(),'U')
    @test Base.MemoryLayout(Adjoint(Hermitian(A))) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{Float64}(),'U')
    @test Base.MemoryLayout(Symmetric(A')) == LinearAlgebra.SymmetricLayout(Base.DenseRowMajor{Float64}(),'U')
    @test Base.MemoryLayout(Hermitian(A')) == LinearAlgebra.SymmetricLayout(Base.DenseRowMajor{Float64}(),'U')
    @test Base.MemoryLayout(Symmetric(transpose(A))) == LinearAlgebra.SymmetricLayout(Base.DenseRowMajor{Float64}(),'U')
    @test Base.MemoryLayout(Hermitian(transpose(A))) == LinearAlgebra.SymmetricLayout(Base.DenseRowMajor{Float64}(),'U')
    B = [1.0+im 2; 3 4]
    @test Base.MemoryLayout(Symmetric(B)) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{ComplexF64}(),'U')
    @test Base.MemoryLayout(Hermitian(B)) == LinearAlgebra.HermitianLayout(Base.DenseColumnMajor{ComplexF64}(),'U')
    @test Base.MemoryLayout(Transpose(Symmetric(B))) == LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{ComplexF64}(),'U')
    @test Base.MemoryLayout(Transpose(Hermitian(B))) == Base.UnknownLayout{ComplexF64}()
    @test Base.MemoryLayout(Adjoint(Symmetric(B))) == LinearAlgebra.ConjLayout(LinearAlgebra.SymmetricLayout(Base.DenseColumnMajor{ComplexF64}(),'U'))
    @test Base.MemoryLayout(Adjoint(Hermitian(B))) == LinearAlgebra.HermitianLayout(Base.DenseColumnMajor{ComplexF64}(),'U')
    @test Base.MemoryLayout(Symmetric(B')) == Base.UnknownLayout{ComplexF64}()
    @test Base.MemoryLayout(Hermitian(B')) == Base.UnknownLayout{ComplexF64}()
    @test Base.MemoryLayout(Symmetric(transpose(B))) == LinearAlgebra.SymmetricLayout(Base.DenseRowMajor{ComplexF64}(),'U')
    @test Base.MemoryLayout(Hermitian(transpose(B))) == LinearAlgebra.HermitianLayout(Base.DenseRowMajor{ComplexF64}(),'U')
