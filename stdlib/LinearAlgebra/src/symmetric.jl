...
Symmetric{T,S}(A::Symmetric) where {T,S<:AbstractMatrix{T}} = Symmetric{T,S}(S(A.data),A.uplo)
AbstractMatrix{T}(A::Symmetric) where {T} = Symmetric(AbstractMatrix{T}(A.data), sym_uplo(A.uplo))
Hermitian{T,S}(A::Hermitian{T,S}) where {T,S<:AbstractMatrix{T}} = A
Hermitian{T,S}(A::Hermitian) where {T,S<:AbstractMatrix{T}} = Hermitian{T,S}(S(A.data),A.uplo)
AbstractMatrix{T}(A::Hermitian) where {T} = Hermitian(AbstractMatrix{T}(A.data), sym_uplo(A.uplo))
