STDLIBS_WITHIN_SYSIMG := FileWatching Sockets

INDEPENDENT_STDLIBS := \
	Artifacts ArgTools Base64 CRC32c Dates DelimitedFiles Distributed Downloads Future \
	InteractiveUtils LazyArtifacts LinearAlgebra Libdl LibGit2 LibCURL Logging Markdown \
	Mmap NetworkOptions Profile Printf Pkg Random REPL Serialization SharedArrays \
	SparseArrays Statistics SHA Tar Test TOML Unicode UUIDs \
	dSFMT_jll GMP_jll libblastrampoline_jll libLLVM_jll LLD_jll LLVMLibUnwind_jll LibUnwind_jll LibUV_jll \
