...
define STDLIB_srcs
$1_SRCS := $$(shell find $$(build_private_libdir)/stdlib/$$(VERSDIR)/$1/src -name \*.jl) \
$$(wildcard $$(build_prefix)/manifest/$$(VERSDIR)/$1) $$(build_private_libdir)/stdlib/$$(VERSDIR)/$1/Project.toml
