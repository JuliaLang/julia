...
macro test_throws(ex)
    # The user passed a single expression, so produce a helpful error message
    return :(error("Incorrect usage of the `@test_throws` macro, expected format: `@test_throws exception expr`"))
end
...
macro test_warn(ex)
    # The user passed a single expression, so produce a helpful error message
    return :(error("Incorrect usage of the `@test_warn` macro, expected format: `@test_warn msg expr`"))
end
