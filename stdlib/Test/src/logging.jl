...
(i.e. not by [`global_logger`](@ref)). In this case, or if you want to test for the
presence or absence of messages to [`stdout`](@ref) or [`stderr`](@ref) which are not
generated by a log statement, see [`@test_out`](@ref), [`@test_warn`](@ref), and
[`@test_nowarn`](@ref).
"""
macro test_logs(exs...)
