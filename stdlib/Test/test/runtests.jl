...
# Note: if the stream of numbers generated by the given RNG changes, then we'll need to
# change the reference results as well and that's fine.
@testset "Set seed of testset" begin
    ...
    @testset seed=Xoshiro(0xc380f460355639ee, 0xb39bc754b7d63bbf, 0x1551dbcfb5ed5668, 0x71ab5a18fec21a25, 0x649d0c1be1ca5436) "Outer" begin
        @test rand() == 0.0004120194925605336
        @testset seed=Xoshiro(0xee97f5b53f7cdc49, 0x480ac387b0527d3d, 0x614b416502a9e0f5, 0x5250cb36e4a4ceb1, 0xed6615c59e475fa0) "Inner: $(i)" for i in 1:10
