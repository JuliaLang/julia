...
known_broken = BitSet([2, 4, 5, 6, 7, 9, 17, 22, 23, 24, 32, 33, 34, 41, 46, 55, 59, 60, 61, 79, 80, 81, 82, 83, 84, 86, 87, 89, 90, 91, 93, 95, 96, 102, 103, 106, 115, 118, 121, 124, 126, 127, 128, 131, 132, 133, 135, 136, 137, 138, 139, 141, 143, 146, 147, 148, 175, 192, 193, 194, 195, 196, 198, 200, 202, 203, 204, 205, 206, 207, 208, 210, 214, 215, 216, 217, 218, 226, 232, 233, 237, 238, 247, 250, 251, 254, 255, 257, 260, 263, 266, 267, 271, 276, 278, 280, 285, 286, 287, 288, 290, 291, 292, 293, 294, 295, 296, 298, 299, 300, 304, 307, 308, 310, 311, 312, 313, 315, 317, 318, 319, 320, 321, 323, 325, 326, 329, 330, 331, 332, 333, 334, 335, 336, 339, 340, 342, 347, 349, 352, 354, 367, 368, 369, 373, 380, 389, 392, 407, 408, 409, 413, 414, 415, 416, 417, 418, 419, 425, 426, 427, 430, 431, 432, 437, 440, 442, 443, 444, 445, 446, 447, 449, 452, 454, 455, 456, 457, 458, 459, 464, 465, 466, 467, 468, 471, 472, 473, 474, 475, 476, 477, 480, 481, 482, 486, 488, 489, 492, 493, 494, 498, 499, 500, 503, 505, 506, 508, 509, 510, 515, 518, 519, 520, 521, 524, 525, 526, 527, 528, 529, 530, 531, 532, 533, 534, 535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 545, 549, 550, 553, 554, 555, 556, 557, 558, 559, 560, 561, 562, 563, 564, 565, 566, 567, 568, 569, 570, 571, 572, 573, 574, 575, 576, 577, 579, 580, 582, 583, 584, 585, 586, 587, 588, 589, 591, 592, 593, 597, 598, 599, 601, 626, 633, 635, 636, 637, 638, 642, 643, 645])
now_passing = Int[]
...
@testset "Thematic breaks" begin
    ...
    # Example 59 (known broken)
    input = "Foo\n---\nbar\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>Foo</h2>\n<p>bar</p>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 59)
...
@testset "Setext headings" begin
    ...
    # Example 80 (known broken)
    input = "Foo *bar*\n=========\n\nFoo *bar*\n---------\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h1>Foo <em>bar</em></h1>\n<h2>Foo <em>bar</em></h2>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 80)
    ...
    # Example 84 (known broken)
    input = "   Foo\n---\n\n  Foo\n-----\n\n  Foo\n  ===\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>Foo</h2>\n<h2>Foo</h2>\n<h1>Foo</h1>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 84)
    ...
    # Example 86 (known broken)
    input = "Foo\n   ----      \n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>Foo</h2>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 86)
    ...
    # Example 89 (known broken)
    input = "Foo  \n-----\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>Foo</h2>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 89)

    # Example 90 (known broken)
    input = "Foo\\\n----\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>Foo\\</h2>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 90)

    # Example 91 (known broken)
    input = "`Foo\n----\n`\n\n<a title=\"a lot\n---\nof dashes\"/>\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>`Foo</h2>\n<p>`</p>\n<h2>&lt;a title=&quot;a lot</h2>\n<p>of dashes&quot;/&gt;</p>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 91)
    ...
    # Example 96 (known broken)
    input = "---\nFoo\n---\nBar\n---\nBaz\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<hr />\n<h2>Foo</h2>\n<h2>Bar</h2>\n<p>Baz</p>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 96)
    ...
    # Example 102 (known broken)
    input = "\\> foo\n------\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>&gt; foo</h2>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 102)

    # Example 103 (known broken)
    input = "Foo\n\nbar\n---\nbaz\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<p>Foo</p>\n<h2>bar</h2>\n<p>baz</p>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 103)
...
@testset "Indented code blocks" begin
    ...
    # Example 115 (known broken)
    input = "# Heading\n    foo\nHeading\n------\n    foo\n----\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h1>Heading</h1>\n<pre><code>foo\n</code></pre>\n<h2>Heading</h2>\n<pre><code>foo\n</code></pre>\n<hr />\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 115)
...
@testset "Fenced code blocks" begin
    ...
    # Example 141 (known broken)
    input = "foo\n---\n~~~\nbar\n~~~\n# baz\n"
    md = Markdown.parse(input; flavor=:github)
    expected = "<h2>foo</h2>\n<pre><code>bar\n</code></pre>\n<h1>baz</h1>\n"
    actual = Markdown.html(md)
    expected == actual && push!(now_passing, 141)
