precompile(Tuple{Pkg.Display.InProject{Base.Dict{String, Any}}, String, Base.Dict{String, Any}})
...
precompile(Tuple{Type{Pkg.GraphType.ResolveLogEntry}, Array{Tuple{Base.UUID, String}, 1}, Base.UUID, String})
precompile(Tuple{Type{Pkg.Pkg2.Reqs.Comment}, String})
precompile(Tuple{Type{Pkg.Pkg2.Reqs.Requirement}, String})
precompile(Tuple{Type{Pkg.REPLMode.Command}, Pkg.REPLMode.CommandKind, Base.SubString{String}})
precompile(Tuple{Type{Pkg.REPLMode.Option}, Pkg.REPLMode.OptionKind, String, Nothing})
precompile(Tuple{Type{Pkg.REPLMode.Rev}, Base.SubString{String}})
precompile(Tuple{Type{Pkg.Resolve.VersionWeights.VersionWeight}, Base.VersionNumber})
...
precompile(Tuple{Type{Pkg.Types.PackageSpec}, String, Base.UUID})
...
precompile(Tuple{Type{Pkg.Types.VersionRange}, Pkg.Types.VersionBound, Pkg.Types.VersionBound})
precompile(Tuple{Type{Pkg.Types.VersionRange}, UInt32, UInt32})
precompile(Tuple{Type{Pkg.Types.VersionRange}, UInt32})
precompile(Tuple{Type{Pkg.Types.VersionSpec}, Array{Any, 1}})
precompile(Tuple{Type{Pkg.Types.VersionSpec}, Array{String, 1}})
precompile(Tuple{Type{Pkg.Types.VersionSpec}, Pkg.Types.VersionRange})
...
precompile(Tuple{getfield(Core, Symbol("#kw#Type")), NamedTuple{(:prompt_prefix, :prompt_suffix, :complete, :sticky), Tuple{String, String, Pkg.REPLMode.PkgCompletionProvider, Bool}}, Type{REPL.LineEdit.Prompt}, String})
...
precompile(Tuple{getfield(Pkg.TOML, Symbol("#kw##printvalue")), NamedTuple{(:sorted,), Tuple{Bool}}, typeof(Pkg.TOML.printvalue), Base.IOStream, Bool})
...
precompile(Tuple{getfield(Pkg.Types, Symbol("#kw##printpkgstyle")), NamedTuple{(:ignore_indent,), Tuple{Bool}}, typeof(Pkg.Types.printpkgstyle), Base.TTY, Symbol, String})
...
precompile(Tuple{typeof(Base.:(-)), Bool, Bool})
precompile(Tuple{typeof(Base.:(<)), Pkg.Resolve.VersionWeights.VersionWeight, Pkg.Resolve.VersionWeights.VersionWeight})
...
precompile(Tuple{typeof(Base._similar_for), Array{Any, 1}, Type{Pkg.Types.VersionRange}, Base.Generator{Array{Any, 1}, Type{Pkg.Types.VersionRange}}, Base.HasShape{1}})
...
precompile(Tuple{typeof(Base.collect_to_with_first!), Array{Pkg.Types.VersionRange, 1}, Pkg.Types.VersionRange, Base.Generator{Array{Any, 1}, Type{Pkg.Types.VersionRange}}, Int64})
...
precompile(Tuple{typeof(Base.convert), Type{Pkg.Types.PackageMode}, Pkg.Types.PackageMode})
...
precompile(Tuple{typeof(Base.convert), Type{Union{Pkg.Types.UpgradeLevel, Base.VersionNumber, Pkg.Types.VersionSpec}}, Pkg.Types.VersionSpec})
...
precompile(Tuple{typeof(Base.foldl), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}})
precompile(Tuple{typeof(Base.foldl), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}})
precompile(Tuple{typeof(Base.foldl), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}})
...
precompile(Tuple{typeof(Base.getindex), Base.Dict{Base.VersionNumber, Base.Dict{String, Pkg.Types.VersionSpec}}, Base.VersionNumber})
...
precompile(Tuple{typeof(Base.getindex), Base.Dict{Pkg.Types.VersionRange, Base.Dict{String, Base.UUID}}, Pkg.Types.VersionRange})
precompile(Tuple{typeof(Base.getindex), Base.Dict{Pkg.Types.VersionRange, Base.Dict{String, Pkg.Types.VersionSpec}}, Pkg.Types.VersionRange})
precompile(Tuple{typeof(Base.getindex), Base.Dict{String, Base.Dict{Base.VersionNumber, Base.Dict{String, Pkg.Types.VersionSpec}}}, String})
precompile(Tuple{typeof(Base.getindex), Base.Dict{String, Base.UUID}, String})
precompile(Tuple{typeof(Base.getindex), Base.Dict{String, Pkg.REPLMode.CommandKind}, Base.SubString{String}})
precompile(Tuple{typeof(Base.getindex), Base.Dict{String, Pkg.REPLMode.OptionKind}, Base.SubString{String}})
...
precompile(Tuple{typeof(Base.getproperty), Pkg.Pkg2.Pkg2Types.VersionSet, Symbol})
...
precompile(Tuple{typeof(Base.haskey), Base.Dict{Base.VersionNumber, Base.Dict{String, Pkg.Types.VersionSpec}}, Base.VersionNumber})
precompile(Tuple{typeof(Base.haskey), Base.Dict{String, Base.Dict{Base.VersionNumber, Base.Dict{String, Pkg.Types.VersionSpec}}}, String})
precompile(Tuple{typeof(Base.haskey), Base.Dict{String, Base.UUID}, String})
precompile(Tuple{typeof(Base.haskey), Base.Dict{String, Pkg.REPLMode.CommandKind}, Base.SubString{String}})
precompile(Tuple{typeof(Base.haskey), Base.Dict{String, Pkg.REPLMode.OptionKind}, Base.SubString{String}})
...
precompile(Tuple{typeof(Base.in), Pkg.Types.VersionRange, Array{Pkg.Types.VersionRange, 1}})
...
precompile(Tuple{typeof(Base.indexed_next), Tuple{Pkg.Types.PackageSpec, Bool, String}, Int64, Int64})
precompile(Tuple{typeof(Base.indexed_next), Tuple{Pkg.Types.PackageSpec, String}, Int64, Int64})
...
precompile(Tuple{typeof(Base.mapfoldl), typeof(Base.identity), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}})
precompile(Tuple{typeof(Base.mapfoldl), typeof(Base.identity), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}})
precompile(Tuple{typeof(Base.mapfoldl), typeof(Base.identity), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}})
precompile(Tuple{typeof(Base.mapfoldl_impl), typeof(Base.identity), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}, Int64})
precompile(Tuple{typeof(Base.mapfoldl_impl), typeof(Base.identity), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}, Int64})
precompile(Tuple{typeof(Base.mapfoldl_impl), typeof(Base.identity), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}, Int64})
precompile(Tuple{typeof(Base.mapfoldl_impl), typeof(Base.identity), typeof(Base.union!), Base.Set{Base.UUID}, Tuple{Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}}, Int64})
...
precompile(Tuple{typeof(Base.promote_eltype), Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}})
precompile(Tuple{typeof(Base.promote_eltype), Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}})
...
precompile(Tuple{typeof(Base.push!), Array{Union{Pkg.Types.VersionRange, String, Pkg.REPLMode.Command, Pkg.REPLMode.Option, Pkg.REPLMode.Rev}, 1}, String})
...
precompile(Tuple{typeof(Base.put!), Base.Channel{Any}, Tuple{Pkg.Types.PackageSpec, String}})
...
precompile(Tuple{typeof(Base.setindex!), Base.Dict{Base.VersionNumber, Base.Dict{String, Pkg.Types.VersionSpec}}, Base.Dict{String, Pkg.Types.VersionSpec}, Base.VersionNumber})
...
precompile(Tuple{typeof(Base.setindex!), Base.Dict{String, Base.Dict{Base.VersionNumber, Base.Dict{String, Pkg.Types.VersionSpec}}}, Base.Dict{Base.VersionNumber, Base.Dict{String, Pkg.Types.VersionSpec}}, String})
...
precompile(Tuple{typeof(Base.setindex!), Base.IdDict{Pkg.GraphType.ResolveLogEntry, Bool}, Bool, Pkg.GraphType.ResolveLogEntry})
precompile(Tuple{typeof(Base.setproperty!), Pkg.GraphType.Graph, Symbol, Array{Any, 1}})
precompile(Tuple{typeof(Base.setproperty!), Pkg.GraphType.Graph, Symbol, Array{Array{Any, 1}, 1}})
...
precompile(Tuple{typeof(Base.setproperty!), Pkg.GraphType.Graph, Symbol, Array{Array{T, 1} where T, 1}})
...
precompile(Tuple{typeof(Base.setproperty!), Pkg.GraphType.GraphData, Symbol, Array{Any, 1}})
...
precompile(Tuple{typeof(Base.setproperty!), Pkg.Types.PackageSpec, Symbol, Pkg.Types.PackageMode})
precompile(Tuple{typeof(Base.setproperty!), Pkg.Types.PackageSpec, Symbol, Pkg.Types.VersionSpec})
...
precompile(Tuple{typeof(Base.showerror), Base.GenericIOBuffer{Array{UInt8, 1}}, Pkg.Types.ResolverError})
precompile(Tuple{typeof(Base.similar), Array{Any, 1}, Type{Pkg.Types.VersionRange}, Tuple{Base.OneTo{Int64}}})
...
precompile(Tuple{typeof(Base.sprint), typeof(Base.showerror), Pkg.Types.ResolverError})
...
precompile(Tuple{typeof(Base.start), Tuple{Pkg.Types.PackageSpec, Bool, String}})
precompile(Tuple{typeof(Base.start), Tuple{Pkg.Types.PackageSpec, String}})
...
precompile(Tuple{typeof(Base.union!), Base.Set{Base.UUID}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}})
precompile(Tuple{typeof(Base.union), Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.Fixed}}, Base.KeySet{Base.UUID, Base.Dict{Base.UUID, Pkg.Types.VersionSpec}}})
...
precompile(Tuple{typeof(Base.vcat), Array{Pkg.Types.VersionRange, 1}, Array{Pkg.Types.VersionRange, 1}, Array{Pkg.Types.VersionRange, 1}, Array{Pkg.Types.VersionRange, 1}})
precompile(Tuple{typeof(Base.vcat), Array{Pkg.Types.VersionRange, 1}, Array{Pkg.Types.VersionRange, 1}})
precompile(Tuple{typeof(Base.vcat), Array{Pkg.Types.VersionRange, 1}})
...
precompile(Tuple{typeof(Core.Compiler.eltype), Type{Array{Array{Pkg.Types.VersionRange, 1}, 1}}})
...
precompile(Tuple{typeof(Core.Compiler.getindex), Tuple{Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(Pkg.Types.read_manifest)}, Int64})
precompile(Tuple{typeof(Core.Compiler.getindex), Tuple{Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(Pkg.Types.read_project)}, Int64})
...
precompile(Tuple{typeof(Core.Compiler.getindex), Type{Any}, GlobalRef, Bool, typeof(Pkg.Types.parse_toml), Expr})
...
precompile(Tuple{typeof(Core.Compiler.length), Tuple{Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(Pkg.Pkg2.Reqs.read)}})
precompile(Tuple{typeof(Core.Compiler.length), Tuple{Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(Pkg.TOML.parse)}})
precompile(Tuple{typeof(Core.Compiler.length), Tuple{Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(Pkg.Types.read_manifest)}})
precompile(Tuple{typeof(Core.Compiler.length), Tuple{Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Base.open), typeof(Pkg.Types.read_project)}})
...
precompile(Tuple{typeof(Core.Compiler.length), Tuple{Base.Iterators.Pairs{Union{}, Union{}, Tuple{}, NamedTuple{(), Tuple{}}}, typeof(Pkg.API.add)}})
...
precompile(Tuple{typeof(Core.Compiler.length), Tuple{Bool, typeof(Pkg.Types.parse_toml)}})
...
precompile(Tuple{typeof(Core.Compiler.length), Tuple{Nothing, Int64, typeof(Base.sprint), typeof(Pkg.GraphType.showlog)}})
...
precompile(Tuple{typeof(Core.Compiler.length), Tuple{typeof(Pkg.BinaryProvider.parse_tar_list)}})
...
precompile(Tuple{typeof(Pkg.API.entrypoint), String, String})
precompile(Tuple{typeof(Pkg.API.project), String, String})
...
precompile(Tuple{typeof(Pkg.Display.print_diff), Base.TTY, Pkg.Types.Context, Array{Pkg.Display.DiffEntry, 1}})
precompile(Tuple{typeof(Pkg.GraphType.showlog), Base.GenericIOBuffer{Array{UInt8, 1}}, Pkg.GraphType.ResolveLog, Base.UUID})
precompile(Tuple{typeof(Pkg.Operations.install_archive), Array{String, 1}, Base.VersionNumber, String})
precompile(Tuple{typeof(Pkg.REPLMode.create_mode), REPL.LineEditREPL, REPL.LineEdit.Prompt})
precompile(Tuple{typeof(Pkg.REPLMode.do_cmd), REPL.LineEditREPL, String})
precompile(Tuple{typeof(Pkg.REPLMode.parse_option), Base.SubString{String}})
...
precompile(Tuple{typeof(Pkg.Resolve.sanity_check), Pkg.GraphType.Graph, Base.Set{Base.UUID}, Bool})
...
precompile(Tuple{typeof(Pkg.Types.pkgID), Base.UUID, Pkg.GraphType.Graph})
precompile(Tuple{typeof(Pkg.Types.printpkgstyle), Base.TTY, Symbol, String, String})
