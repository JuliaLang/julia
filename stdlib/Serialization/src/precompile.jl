...
precompile(Tuple{typeof(Serialization.object_number), TypeName})
...
precompile(Tuple{typeof(Serialization.serialize), Serialization.Serializer{Base.Pipe}, SimpleVector})
...
precompile(Tuple{typeof(Serialization.serialize), Serialization.Serializer{Base.Pipe}, TypeName})
...
precompile(Tuple{typeof(Serialization.serialize_cycle), Serialization.Serializer{Base.Pipe}, TypeName})
...
precompile(Tuple{typeof(Serialization.serialize_typename), Serialization.Serializer{Base.Pipe}, TypeName})
