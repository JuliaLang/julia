...
@testset "Syntax highlighting" begin
    ...
    StyledStrings.withfaces(StyledStrings.face"JuliaSyntaxHighlighting.keyword" => StyledStrings.Face(foreground=face"red"),
                            StyledStrings.face"JuliaSyntaxHighlighting.number" => StyledStrings.Face(foreground=face"blue")) do
