...
@test TerminalMenus.header(multi_menu) == "[press: Enter=select, d=done, a=all, n=none]"
...
for kws in ((charset=:ascii,),
    ...
    @test startswith(String(take!(buf)), string("\e[2K[press: Enter=select, d=done, a=all, n=none]\r\n\e[2K $cur $uck 1"))
