...
scroll_wrap(::AbstractMenu)::Bool = CONFIG[:scroll_wrap]
...
down_arrow(::AbstractMenu)::Char = CONFIG[:down_arrow]
...
updown_arrow(::AbstractMenu)::Char = CONFIG[:updown_arrow]
