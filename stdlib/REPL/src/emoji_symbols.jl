...
function emoji_data(url)
    ...
    for emj in emojis
        name = "\\:" * emj["short_name"] * ":"
        unicode = split(emj["unified"], '-')
        result[name] = parse.(UInt32, unicode, base = 16) .|> Char |> prod
    end
    return result
end
...
result = mapfoldr(emoji_data, merge, [
    ...
    "https://raw.githubusercontent.com/iamcal/emoji-data/0f0cf4ea8845eb52d26df2a48c3c31c3b8cad14e/emoji_pretty.json", # before v2
    "https://raw.githubusercontent.com/iamcal/emoji-data/e512953312c012f6bd00e3f2ef6bf152ca3710f8/emoji_pretty.json", # v6.0.1 ish
    "https://raw.githubusercontent.com/iamcal/emoji-data/a8174c74675355c8c6a9564516b2e961fe7257ef/emoji_pretty.json", # v15.1.2
    "https://raw.githubusercontent.com/iamcal/emoji-data/13ee711e222ea17fe537bfea953c687866f16411/emoji_pretty.json", # v17.0.0
    ];
    init=Dict()
)

skeys = sort(collect(keys(result)))
prefix = readlines("emoji_symbols.jl")[1:45]
