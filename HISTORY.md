...
* An "Numbered mode" which mimics the behaviour of the prompts and storing the evaluated result in `Out` can be
  activated with `REPL.numbered_mode!()`. See the manual for how to enable this at startup ([#46474]).
