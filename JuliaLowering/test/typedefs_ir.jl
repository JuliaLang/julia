...
29  (call core.svec)
30  (call core.svec)
31  (call JuliaLowering.eval_closure_type TestMod :#f##0 %₂₉ %₃₀)
32  latestworld
33  TestMod.#f##0
34  (new %₃₃)
35  (= slot₂/f %₃₄)
...
64  (call core.svec %₆₃ core.Any core.Any)
65  (call core.svec)
66  SourceLocation::6:5
67  (call core.svec %₆₄ %₆₅ %₆₆)
...
69  latestworld
70  TestMod.X
71  (call core.apply_type core.Type %₇₀)
72  (call core.svec %₇₁ core.Any core.Any core.Any)
73  (call core.svec)
74  SourceLocation::10:5
75  (call core.svec %₇₂ %₇₃ %₇₄)
...
56  --- method core.nothing %₅₅
    ...
    3   (return %₂)
57  latestworld
58  (= slot₆/U (call core.TypeVar :U))
59  (= slot₇/V (call core.TypeVar :V))
60  TestMod.X
61  slot₆/U
62  slot₇/V
...
73  (call core.svec)
74  (call core.svec)
75  (call JuliaLowering.eval_closure_type TestMod :#f##1 %₇₃ %₇₄)
76  latestworld
77  TestMod.#f##1
78  (new %₇₇)
79  (= slot₅/f %₇₈)
...
81  (call core.svec %₈₀)
82  (call core.svec)
83  SourceLocation::5:5
84  (call core.svec %₈₁ %₈₂ %₈₃)
85  --- method core.nothing %₈₄
    slots: [slot₁/#self#(!read)]
    1   TestMod.X
    2   TestMod.A
    3   TestMod.B
