...
12  --- method core.nothing %₁₁
    ...
    1   10
    2   (call core.setfield! slot₁/#self# :x %₁)
    3   (return %₁)
13  latestworld
14  TestMod.f
...
19  (call core.svec %₁₆ %₁₇ %₁₈)
20  --- method TestMod.f %₁₉
    slots: [slot₁/#self#(!read) slot₂/x(single_assign) slot₃/g(single_assign,called) slot₄/x(!read)]
    1   (= slot₄/x slot₂/x)
    2   TestMod.#f#g##0
    3   slot₄/x
    4   (new %₂ %₃)
...
12  --- method core.nothing %₁₁
    ...
    1   (= slot₂/z 3)
    2   (call core.isdefined slot₁/#self# :y)
    3   (isdefined slot₂/z)
...
20  --- method TestMod.f %₁₉
    ...
    2   (newvar slot₄/y)
    3   TestMod.#f#g##3
    4   (call core._typeof_captured_variable slot₂/x)
    5   (call core.apply_type %₃ %₄)
    6   (new %₅ slot₂/x)
    7   (isdefined slot₄/y)
    8   (gotoifnot %₇ label₁₂)
    9   slot₄/y
    10  (call core.setfield! %₆ :y %₉)
    11  (goto label₁₂)
    12  (= slot₃/g %₆)
    13  2
    14  slot₃/g
    15  (call core.setfield! %₁₄ :y %₁₃)
    16  slot₃/g
    17  (call core.isdefined %₁₆ :y)
    18  (call core.tuple %₁₇ true)
    19  (return %₁₈)
21  latestworld
22  TestMod.f
23  (return %₂₂)
