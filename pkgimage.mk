...
default: release
release: all-release toml-stdlibs
debug: all-debug toml-stdlibs
all: release debug
...
$(build_datarootdir)/julia/stdlib/$(VERSDIR)/stdlibs.toml:
	@echo "# This file is automatically generated in stdlib/Makefile" > $@
	@echo -n "independent = [" >> $@
	@echo -e $(foreach stdlib,$(INDEPENDENT_STDLIBS),"\n  \"$(stdlib)\",") >> $@
	@echo "]" >> $@
	@echo -n "bundled = [" >> $@
	@echo -e $(foreach stdlib,$(STDLIBS_WITHIN_SYSIMG),"\n  \"$(stdlib)\",") >> $@
	@echo "]" >> $@


.SECONDARY: $(build_datarootdir)/julia/stdlib/$(VERSDIR)/stdlibs.toml
toml-stdlibs: $(build_datarootdir)/julia/stdlib/$(VERSDIR)/stdlibs.toml
clean-toml-stdlibs:
	@rm -rf $(build_datarootdir)/julia/stdlib/$(VERSDIR)/stdlibs.toml
