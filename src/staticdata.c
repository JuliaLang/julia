...
#define XX(name, type) jl_queue_for_serialization(&s, (jl_value_t*)sysimg_global.name);
            JL_EXPORTED_DATA_POINTERS(XX)
#undef XX
#define XX(name, type) jl_queue_for_serialization(&s, (jl_value_t*)const_globals.jl##name);
...
#define XX(name, type) jl_write_value(&s, (jl_value_t*)sysimg_global.name);
            JL_EXPORTED_DATA_POINTERS(XX)
#undef XX
#define XX(name, type) jl_write_value(&s, (jl_value_t*)const_globals.jl##name);
            JL_CONST_GLOBAL_VARS(XX)
#undef XX
...
#define XX(name, type) sysimg_global.name = (type)jl_read_value(&s);
        JL_EXPORTED_DATA_POINTERS(XX)
#undef XX
#define XX(name, type) const_globals.jl##name = (type)jl_read_value(&s);
        JL_CONST_GLOBAL_VARS(XX)
#undef XX
#define XX(name) \
