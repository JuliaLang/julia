...
static void jl_init_serializer2(int for_serialize)
{
    ...
    void *tags[] = { ptls->root_task,
                     ...
                     jl_gotonode_type, jl_detachnode_type, jl_reattachnode_type,
                     jl_syncnode_type, jl_quotenode_type,
                     ...
                     jl_gotonode_type->name, jl_detachnode_type->name, jl_reattachnode_type,
                     jl_syncnode_type, jl_quotenode_type->name,
