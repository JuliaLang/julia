                                          ...
                                          fintrinsic_op1 *floatop, fintrinsic_op1 *doubleop)
{
    ...
    default:
        jl_errorf("%s: runtime floating point intrinsics are not implemented for bit sizes "
                  "other than 32 and 64",
                  name);
    }
    return newv;
}
...
#define bi_fintrinsic(OP, name)                                                            \
    ...
    {                                                                                      \
        ...
        default:                                                                           \
            jl_error(#name ": runtime floating point intrinsics are not implemented for "  \
...
#define fpcvt(pr, a)                                                                       \
    if (osize == 32)                                                                       \
        ...
        *(double *)pr = a;                                                                 \
        ...
        jl_error("fptrunc/fpext: runtime floating point intrinsics are not implemented "   \
                            ...
                            JL_DLLEXPORT jl_value_t *jl_fptoui_auto(jl_value_t *a)
{
    ...
    default:
        jl_error("fptoui: runtime floating point intrinsics are not implemented for bit "
                 "sizes other than 32 and 64");
    }
...
#define check_sadd_int(a, b)                                                               \
    /* this test is a reduction of (b > 0) ? (a + b > typemax(a)) : (a + b < typemin(a))   \
     * ==> overflow                                                                        \
    ...
    jl_value_t *jl_powi_llvm(jl_value_t *a, jl_value_t *b)
{
    ...
    default:
        jl_error("powi_llvm: runtime floating point intrinsics are not implemented for bit "
                 "sizes other than 32 and 64");
    }
    return newv;
}
