...
JL_DLLEXPORT jl_code_instance_t* jl_new_codeinst(
        ...
        int32_t const_flags, size_t min_world, size_t max_world, uint8_t relocatability, jl_value_t *arg_escapes);
        ...
        /*, jl_array_t *edges, int absolute_max*/)
{
    ...
    codeinst->arg_escapes = arg_escapes;
    return codeinst;
}
