...
static void invalidate_missing_backedges(struct _typename_invalidate_backedge *env)
{
...
// signature.
static void jl_method_table_invalidate(jl_method_t *replaced, size_t max_world, int deleted)
{
