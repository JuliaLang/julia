...
// PM->add(createCFGSimplificationPass());    // Merge & remove BBs
    ...
    PM->add(createLowerSimdLoopPass()); // Annotate loop marked with "simdloop" as LLVM
                                        // parallel loop
...
// TODO: hook up RegisterJITEventListener, instead of hard-coding the GDB and JuliaListener
// targets
...
// declaration
// TODO: consider moving this into jl_add_to_shadow or jl_dump_shadow? the JIT doesn't care,
// so most calls are now no-ops
...
// to finalizing a function, look up its name in the `module_for_fname` map of unfinalized
// functions
...
// (for values created locally or in the sysimage, jl_emit_and_add_to_shadow is generally
// preferable)
#ifdef LLVM35
...
//
// if in imaging_mode, emit a GlobalVariable with the same name and an initializer to the
// shadow_module
