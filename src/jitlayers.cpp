...
void jl_generate_fptr_for_unspecialized_impl(jl_code_instance_t *unspec)
{
    ...
    if (src) {
        ...
        if (!jl_is_compiled_codeinst(unspec)) {
            ...
            jl_gc_wb_post(unspec, debuginfo);
