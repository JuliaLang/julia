...
static const char opts[] =
    ...
    "processes\n"
    "                           \"auto\" launches as many workers as the number of local "
    "cores\n"
    ...
    " -O, --optimize={0,1,2,3}  Set the optimization level (default 2 if unspecified or 3 "
    "if specified as -O)\n"
    ...
    "declarations)\n"
    " --math-mode={ieee,fast}   Disallow or enable unsafe floating point optimizations "
    ...
    " --output-incremental=no   Generate an incremental output file (rather than "
    "complete)\n\n"

    // instrumentation options
    " --code-coverage={none|user|all}, --code-coverage\n"
    "                           Count executions of source lines (omitting setting is "
    "equivalent to \"user\")\n"
...
JL_DLLEXPORT void jl_parse_opts(int *argcp, char ***argvp)
{
    ...
    restart_switch:
        ...
        case 'P': // post-boot
            jl_printf(
                JL_STDOUT,
                "WARNING: julia -P/--post-boot option is deprecated, use -i -e instead.\n");
        ...
        case opt_no_history_file:
            jl_printf(JL_STDOUT, "WARNING: julia --no-history-file option is deprecated, "
                                 "use --history-file=no instead.\n");
            jl_options.historyfile = JL_OPTIONS_HISTORYFILE_OFF;
            break;
        case opt_startup_file:
            ...
            break;
        case 'f':
            jl_printf(JL_STDOUT, "WARNING: julia -f/--no-startup option is deprecated, use "
                                 "--startup-file=no instead.\n");
            jl_options.startupfile = JL_OPTIONS_STARTUPFILE_OFF;
            break;
        case 'F':
