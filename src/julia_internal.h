...
JL_DLLEXPORT jl_value_t *jl_shl_int_native(jl_value_t *a, jl_value_t *b);
JL_DLLEXPORT jl_value_t *jl_lshr_int_native(jl_value_t *a, jl_value_t *b);
JL_DLLEXPORT jl_value_t *jl_ashr_int_native(jl_value_t *a, jl_value_t *b);
