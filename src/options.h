...
// Options in here are NOT allowed to affect the jlapi, since that would require
// this header to be installed
...
#define KEEP_BODIES
#endif
// Memory sanitizer needs TLS, which llvm only supports for the small memory
// model
