                 ...
                 bool isSigned, bool *isExact)
{
    ...
    if (numbits == 32)
        ...
        jl_error("FPtoSI: runtime floating point intrinsics are not implemented for bit "
    ...
    if (onumbits <= 64) { // fast-path, if possible
        ...
        APFloat::opStatus status =
            a.convertToInteger(parts, onumbits, isSigned, rounding_mode, &isVeryExact);
                                        ...
                                        unsigned onumbits, integerPart *pr)
{
    ...
    if (onumbits == 32)
        ...
        *(double *)pr = val;
        ...
        jl_error("SItoFP: runtime floating point intrinsics are not implemented for bit "
                 "sizes other than 32 and 64");
}
                                        ...
                                        unsigned onumbits, integerPart *pr)
{
    ...
    if (onumbits == 32)
        ...
        *(double *)pr = val;
        ...
        jl_error("UItoFP: runtime floating point intrinsics are not implemented for bit "
                 "sizes other than 32 and 64");
}
