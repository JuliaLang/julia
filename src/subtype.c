...
static jl_tvar_t *binding_var(jl_stenv_t *e, jl_varbinding_t *vb) JL_GLOBALLY_ROOTED;
...
static jl_tvar_t *stenv_binding_var(jl_stenv_t *e, jl_unionall_t *u, jl_value_t *lb, jl_value_t *ub,
                                    jl_varbinding_t *frame_prev, jl_value_t *t) JL_GLOBALLY_ROOTED
{
...
static jl_value_t *resolve_tvarref(jl_value_t *t JL_PROPAGATES_ROOT, jl_varbinding_t *frame, jl_stenv_t *e)
{
    if (jl_is_tvarref(t)) {
...
// substitution memo
static jl_value_t *binding_lb(jl_stenv_t *e, jl_varbinding_t *vb) JL_GLOBALLY_ROOTED
{
    jl_value_t *lb = vb->lb;
...
static jl_value_t *binding_ub(jl_stenv_t *e, jl_varbinding_t *vb) JL_GLOBALLY_ROOTED
{
    jl_value_t *ub = vb->ub;
...
static void binding_force_bounds(jl_stenv_t *e, jl_varbinding_t *vb)
{
...
static void mark_required_tuple_element(jl_stenv_t *e, jl_value_t *rhs) JL_NOTSAFEPOINT
{
    ...
    for (jl_varbinding_t *b = e->Rframe; b != NULL; b = b->frame_prev, d++) {
        if (b->existential && b->lb != jl_bottom_type && !b->lb_required &&
            constrains_ref_static(d, b->u->ub == (jl_value_t*)jl_any_type, rhs, 1))
            b->lb_required = 1;
    }
    ...
    *ans = jl_bottom_type;
    ...
    if (sz == 0 && szb > 0) {
        ...
        while (jl_is_unionall(ub)) {
            ...
            nvars++;
            int constrained = constrains_ref_static(1, ub->ub == (jl_value_t*)jl_any_type, ub->body, 1);
            env[i++] = wrap_tvar_env((jl_value_t*)v, constrained);
...
static int sub_msp(jl_value_t *x, jl_value_t *y, jl_value_t *y0, jl_specenv_t *xenv, jl_specenv_t *yenv);
static int eq_msp(jl_value_t *a, jl_value_t *b, jl_value_t *a0, jl_value_t *b0, jl_specenv_t *aenv, jl_specenv_t *benv);
...
static int type_morespecific_(jl_value_t *a, jl_value_t *b, jl_value_t *a0, jl_value_t *b0, int invariant, jl_specenv_t *aenv, jl_specenv_t *benv);
...
static jl_value_t *spec_resolve_ref(jl_value_t *t, jl_specenv_t *env)
{
    if (!jl_is_tvarref(t))
        return t;
    jl_specenv_t *node = specenv_lookup(env, jl_tvarref_depth(t));
...
static int tuple_morespecific(jl_datatype_t *cdt, jl_datatype_t *pdt, jl_value_t *c0, jl_value_t *p0, int invariant, jl_specenv_t *cenv, jl_specenv_t *penv)
{
...
static int args_morespecific_fix1(jl_value_t *a, jl_value_t *b, jl_value_t *a0, jl_value_t *b0, int swap, jl_specenv_t *aenv, jl_specenv_t *benv)
{
...
static int type_morespecific_var_(jl_value_t *a, jl_value_t *b, jl_value_t *a0, jl_value_t *b0, int invariant,
                                  jl_specenv_t *aenv, jl_specenv_t *benv, int acount, int bcount)
{
    if (jl_is_typevar(a)) {
        if (jl_is_typevar(b)) {
