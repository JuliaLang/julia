...
JL_DLLEXPORT jl_value_t *jl_genericmemory_to_string(jl_genericmemory_t *m, size_t len)
{
    ...
    if (how != JL_GENERICMEMORY_INLINED && how != JL_GENERICMEMORY_LIBCALLOCATED) {
