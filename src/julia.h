...
// Initialize Julia from a statically linked runtime + system image (static
// libjulia-internal only). On Windows, define JL_LIBRARY_STATIC before
// including this header so the declarations are not dllimport.
