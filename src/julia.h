...
extern JL_DLLEXPORT jl_datatype_t *jl_int128_type;
extern JL_DLLEXPORT jl_datatype_t *jl_uint128_type;
...
JL_DLLEXPORT jl_datatype_t *jl_new_datatype(jl_sym_t *name,
                                            ...
                                            int ninitialized);
JL_DLLEXPORT jl_datatype_t *jl_new_primitivetype_aligned(jl_value_t *name,
                                                 jl_module_t *module,
                                                 jl_datatype_t *super,
                                                 jl_svec_t *parameters, size_t nbits, size_t alignment);
