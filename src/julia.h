...
#define jl_detachnode_task(x) (((jl_value_t**)(x))[1])
#define jl_detachnode_label(x) (((intptr_t*)(x))[2])
#define jl_detachnode_reattach(x) (((intptr_t*)(x))[3])
#define jl_reattachnode_task(x) (((jl_value_t**)(x))[1])
#define jl_reattachnode_retval(x) (((jl_value_t**)(x))[2])
#define jl_reattachnode_label(x) (((intptr_t*)(x))[3])
