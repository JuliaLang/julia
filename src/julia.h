...
typedef struct {
    ...
    uint8_t sealed:1; // method set declared closed to other modules; inference may assume completeness
    uint8_t _unused:4;
...
JL_DLLEXPORT void jl_typename_set_sealed(jl_typename_t *tn, int sealed);
