...
JL_DLLEXPORT uint32_t jl_create_system_image(void **, jl_array_t *worklist, int emit_split, int compress, ios_t **s, jl_array_t **udeps, int64_t *srctextpos, jl_array_t *module_init_order);
