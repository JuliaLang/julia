...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_debuginfo_type =
        jl_new_datatype(jl_symbol("DebugInfo"), core,
                        ...
                        jl_svec(4,
                            ...
                            jl_any_type, // simplevector of debuginfo, or a compact edge list in images
                            jl_string_type),
                        jl_emptysvec, 0, 0, 4);
    ...
    jl_code_instance_type =
        jl_new_datatype(jl_symbol("CodeInstance"), core,
                        ...
                        jl_svec(20,
                            ...
                            jl_any_type,
                            jl_debuginfo_type,
                            jl_any_type, // edges: SimpleVector, or a compact edge list in images
                            jl_any_type,
                            jl_uint32_type,
                            jl_uint16_type,
                            jl_uint16_type,
    ...
    // Compact image form of a CodeInstance's edge list. The encoded words follow the
    // declared fields in the same allocation. They refer only to immortal image objects,
    // so the GC does not need to trace them.
