...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    const static uint32_t code_instance_constfields[1]  = { 0b00000110100011100011 }; // Set fields 1, 2, 6-8, 12, 14-15 as const
    const static uint32_t code_instance_atomicfields[1] = { 0b11111001011100011100 }; // Set fields 3-5, 9-12, 13, 16-20 as atomic
