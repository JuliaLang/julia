...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    jl_method_table = jl_new_method_table(jl_symbol("_"), core);
    ...
    jl_type_type_mt = jl_datatype_type->name->mt;
    jl_type_type_mt->name = type_type->name->name;
    ...
    jl_methcache_type->name->n_uninitialized = 10 - 7;
    jl_methcache_type->name->names = jl_perm_symsvec(10, "leafcache", "cache", "max_args",
                                                     "offs", "", "name", "module", "backedges",
                                                     "", "");
    const static uint32_t methcache_constfields[1] = { 0b0 };
    const static uint32_t methcache_atomicfields[1] = { 0b0000000111 };
    jl_methcache_type->name->constfields = methcache_constfields;
    jl_methcache_type->name->atomicfields = methcache_atomicfields;
    jl_precompute_memoized_dt(jl_methcache_type, 1);
    jl_methcache_type->types = jl_svec(10, jl_any_type, jl_any_type, jl_any_type/*int32*/,
                                       jl_any_type/*uint8*/, jl_any_type/*uint8*/,
                                       jl_symbol_type, jl_any_type/*module*/, jl_any_type/*any vector*/,
    ...
    jl_methtable_type->name->names = jl_perm_symsvec(2, "defs", "cache");
    const static uint32_t methtable_constfields[1] = { 0b10 };
    const static uint32_t methtable_atomicfields[1] = { 0b01 };
    ...
    jl_methtable_type->types = jl_svec(2, jl_any_type, jl_methcache_type);
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    // all Kinds share the Type method cache
    ...
    jl_svecset(jl_methcache_type->types, 2, jl_int32_type);
    jl_svecset(jl_methcache_type->types, 3, jl_uint8_type);
    jl_svecset(jl_methcache_type->types, 4, jl_uint8_type);
    jl_svecset(jl_methcache_type->types, 6, jl_module_type);
    jl_svecset(jl_methcache_type->types, 7, jl_array_any_type);
    jl_svecset(jl_methcache_type->types, 8, jl_long_type); // voidpointer
    jl_svecset(jl_methcache_type->types, 9, jl_long_type); // uint32_t plus alignment
