...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    jl_typename_type->name->names = jl_perm_symsvec(19, "name", "module", "singletonname",
                                                    ...
                                                    "partial", "enumtab", "hash", "max_args", "n_uninitialized",
                                                    "flags", // "abstract", "mutable", "mayinlinealloc", "isenumtype",
    ...
    const static uint32_t typename_atomicfields[1] = { 0b0010010101110000000 };
