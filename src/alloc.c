...
jl_sym_t *jl_incomplete_block_sym;
jl_sym_t *jl_incomplete_char_sym;
jl_sym_t *jl_incomplete_cmd_sym;
jl_sym_t *jl_incomplete_comment_sym;
jl_sym_t *jl_incomplete_string_sym;
