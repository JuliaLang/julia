...
convert(::Type{Int8}, x::Float32) = boxsi8(trunc8(fpiround32(unbox32(x))))
convert(::Type{Int8}, x::Float64) = boxsi8(trunc8(fpiround64(unbox64(x))))
...
convert(::Type{Uint8}, x::Float32) = boxui8(trunc8(fpiround32(unbox32(x))))
convert(::Type{Uint8}, x::Float64) = boxui8(trunc8(fpiround64(unbox64(x))))
...
convert(::Type{Int16}, x::Float32) = boxsi16(trunc16(fpiround32(unbox32(x))))
convert(::Type{Int16}, x::Float64) = boxsi16(trunc16(fpiround64(unbox64(x))))
...
convert(::Type{Uint16}, x::Float32) = boxui16(trunc16(fpiround32(unbox32(x))))
convert(::Type{Uint16}, x::Float64) = boxui16(trunc16(fpiround64(unbox64(x))))
...
convert(::Type{Int32}, x::Float32) = boxsi32(fpiround32(unbox32(x)))
convert(::Type{Int32}, x::Float64) = boxsi32(trunc32(fpiround64(unbox64(x))))
...
convert(::Type{Uint32}, x::Float32) = boxui32(fpiround32(unbox32(x)))
convert(::Type{Uint32}, x::Float64) = boxui32(trunc32(fpiround64(unbox64(x))))
...
convert(::Type{Int64}, x::Float32) = boxsi64(sext64(fpiround32(unbox32(x))))
convert(::Type{Int64}, x::Float64) = boxsi64(fpiround64(unbox64(x)))
...
convert(::Type{Uint64}, x::Float32) = boxui64(sext64(fpiround32(unbox32(x))))
convert(::Type{Uint64}, x::Float64) = boxui64(fpiround64(unbox64(x)))
