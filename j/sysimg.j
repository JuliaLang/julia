...
compile_hint(assign, (HashTable{Any,Any}, WorkItem, (Int32,Int32)))
compile_hint(isequal, ((Int32,Int32),(Int32,Int32)))
compile_hint(RemoteRef, (Int, Int32, Int32))
