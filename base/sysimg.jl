...
precompile(next, (Dict{Any,Any,Unordered}, Int))
precompile(start, (Dict{Any,Any,Unordered},))
...
precompile(Dict{Any,Any,Unordered}, (Int,))
precompile(Set, ())
precompile(setindex!, (Dict{Any,Any,Unordered}, Bool, Cmd))
precompile(_setindex!, (Dict{Any,Any,Unordered}, Bool, Cmd))
precompile(rehash, (Dict{Any,Any,Unordered}, Int))
