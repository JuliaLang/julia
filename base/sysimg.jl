...
StridedReshapedArray{T,N,A<:Union{DenseArray,StridedIndexSubArray{<:Any,<:Any,<:DenseArray}}} = ReshapedArray{T,N,A}
StridedSubArray{T,N,A<:Union{DenseArray, StridedReshapedArray}} = StridedIndexSubArray{T,N,A}
StridedReinterpretArray{T,N,A<:Union{DenseArray,StridedReshapedArray,StridedSubArray}} = ReinterpretArray{T,N,S,A} where S
