...
export
    ...
    atand,atanh,begins_with,betarnd,bfft,bfftn,bin,binomial,bitmix,bits,bool,
    ...
    escape_string,exec,exit,exp,exp2,expm1,expr,exprnd,eye,
    ...
    force,foreach,fork,fpart,fprintf,frexp,full,function_loc,gamma,gc,
    ...
    tanh,thisind,tic,tiedrank,time,tintersect,tls,tmpnam,toc,toggle,toggle_each,
