...
export
    ...
    colon,colvec,combinations,compile_hint,complement,complement!,complex,complex128,
    ...
    rotl90,rotr90,round,rowvec,rpad,rr2id,rref,rstrip,run,safe_char,scan,search,
