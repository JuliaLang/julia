...
include("string.jl")
include("search.jl")
include("stringcmp.jl")
include("SubStrings.jl")
include("stringhash.jl")
include("stringpad.jl")
include("stringreplace.jl")
include("stringjoin.jl")
include("stringchop.jl")
include("stringmap.jl")
include("stringescape.jl")
include("stringsplit.jl")
include("RevStrings.jl")
include("stringstrip.jl")
include("stringparse.jl")
include("stringhex.jl")
include("stringpnt.jl")
include("stringio.jl")
include("parser.jl")
include("indent.jl")
include("shell.jl")
