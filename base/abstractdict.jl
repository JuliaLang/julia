...
Base.OrderedDict{Char, Int64} with 2 entries:
  'a' => 2
  'b' => 3
...
julia> d1
Base.OrderedDict{Int64, Int64} with 3 entries:
  1 => 4
  3 => 4
  4 => 5
```
...
Base.OrderedDict{String, Float64} with 2 entries:
  "foo" => 0.0
  "bar" => 42.0
...
julia> merge(a, b)
Base.OrderedDict{String, Float64} with 3 entries:
  "foo" => 0.0
  "bar" => 4711.0
  "baz" => 17.0
...
Base.OrderedDict{Int64, String} with 3 entries:
  1 => "a"
  2 => "b"
  3 => "c"

julia> filter!(p->isodd(p.first), d)
Base.OrderedDict{Int64, String} with 2 entries:
  1 => "a"
  3 => "c"
```
"""
...
julia> filter(p->isodd(p.first), d)
Base.OrderedDict{Int64, String} with 1 entry:
  1 => "a"
```
"""
function filter(f, d::AbstractDict)
...
Base.OrderedDict{Symbol, Int64} with 2 entries:
  :a => 1
  :b => 2

julia> map!(v -> v-1, values(d))
ValueIterator for a Base.OrderedDict{Symbol, Int64} with 2 entries. Values:
  0
  1
```
"""
