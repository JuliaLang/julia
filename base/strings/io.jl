...
setfield!(typeof(print).name.mt, :max_args, Int32(10), :monotonic)
...
setfield!(typeof(println).name.mt, :max_args, Int32(10), :monotonic)
...
setfield!(typeof(print_to_string).name.mt, :max_args, Int32(10), :monotonic)
