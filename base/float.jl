...
convert(::Type{Float32}, x::Bool)    = boxf32(sitofp32(unbox(Bool,x)))
convert(::Type{Float32}, x::Char)    = boxf32(uitofp32(unbox(Float32,x)))
convert(::Type{Float32}, x::Int8)    = boxf32(sitofp32(unbox(Int8,x)))
convert(::Type{Float32}, x::Int16)   = boxf32(sitofp32(unbox(Int16,x)))
convert(::Type{Float32}, x::Int32)   = boxf32(sitofp32(unbox(Int32,x)))
convert(::Type{Float32}, x::Int64)   = boxf32(sitofp32(unbox(Int64,x)))
convert(::Type{Float32}, x::Uint8)   = boxf32(uitofp32(unbox(Uint8,x)))
convert(::Type{Float32}, x::Uint16)  = boxf32(uitofp32(unbox(Uint16,x)))
convert(::Type{Float32}, x::Uint32)  = boxf32(uitofp32(unbox(Uint32,x)))
convert(::Type{Float32}, x::Uint64)  = boxf32(uitofp32(unbox(Uint64,x)))
convert(::Type{Float32}, x::Float64) = boxf32(fptrunc32(unbox(Float64,x)))

convert(::Type{Float64}, x::Bool)    = boxf64(sitofp64(unbox(Bool,x)))
convert(::Type{Float64}, x::Char)    = boxf64(uitofp64(unbox(Char,x)))
convert(::Type{Float64}, x::Int8)    = boxf64(sitofp64(unbox(Int8,x)))
convert(::Type{Float64}, x::Int16)   = boxf64(sitofp64(unbox(Int16,x)))
convert(::Type{Float64}, x::Int32)   = boxf64(sitofp64(unbox(Int32,x)))
convert(::Type{Float64}, x::Int64)   = boxf64(sitofp64(unbox(Int64,x)))
convert(::Type{Float64}, x::Uint8)   = boxf64(uitofp64(unbox(Uint8,x)))
convert(::Type{Float64}, x::Uint16)  = boxf64(uitofp64(unbox(Uint16,x)))
convert(::Type{Float64}, x::Uint32)  = boxf64(uitofp64(unbox(Uint32,x)))
convert(::Type{Float64}, x::Uint64)  = boxf64(uitofp64(unbox(Uint64,x)))
convert(::Type{Float64}, x::Float32) = boxf64(fpext64(unbox(Float32,x)))
...
if WORD_SIZE == 64
    ...
    iround(x::Float32) = boxsi32(fpsiround32(unbox(Float32,x)))
    itrunc(x::Float32) = boxsi32(fptosi32(unbox(Float32,x)))
end
iround(x::Float64) = boxsi64(fpsiround64(unbox(Float64,x)))
itrunc(x::Float64) = boxsi64(fptosi64(unbox(Float64,x)))
...
-(x::Float32) = boxf32(neg_float(unbox(Float32,x)))
-(x::Float64) = boxf64(neg_float(unbox(Float64,x)))
+(x::Float32, y::Float32) = boxf32(add_float(unbox(Float32,x), unbox(Float32,y)))
+(x::Float64, y::Float64) = boxf64(add_float(unbox(Float64,x), unbox(Float64,y)))
-(x::Float32, y::Float32) = boxf32(sub_float(unbox(Float32,x), unbox(Float32,y)))
-(x::Float64, y::Float64) = boxf64(sub_float(unbox(Float64,x), unbox(Float64,y)))
*(x::Float32, y::Float32) = boxf32(mul_float(unbox(Float32,x), unbox(Float32,y)))
*(x::Float64, y::Float64) = boxf64(mul_float(unbox(Float64,x), unbox(Float64,y)))
/(x::Float32, y::Float32) = boxf32(div_float(unbox(Float32,x), unbox(Float32,y)))
/(x::Float64, y::Float64) = boxf64(div_float(unbox(Float64,x), unbox(Float64,y)))

# TODO: faster floating point div?
# TODO: faster floating point fld?
# TODO: faster floating point mod?

rem(x::Float32, y::Float32) = boxf32(rem_float(unbox(Float32,x), unbox(Float32,y)))
rem(x::Float64, y::Float64) = boxf64(rem_float(unbox(Float64,x), unbox(Float64,y)))
...
const Inf32 = boxf32(unbox(Uint32,0x7f800000))
const NaN32 = boxf32(unbox(Uint32,0x7fc00000))
const Inf = boxf64(unbox(Uint64,0x7ff0000000000000))
const NaN = boxf64(unbox(Uint64,0x7ff8000000000000))
...
@eval begin
    ...
    isdenormal(x::Float32) = (abs(x) < $boxf32(unbox(Uint32,0x00800000)))
    isdenormal(x::Float64) = (abs(x) < $boxf64(unbox(Uint64,0x0010000000000000)))
    ...
    realmin(::Type{Float32}) = $boxf32(unbox(Uint32,0x00800000))
    realmin(::Type{Float64}) = $boxf64(unbox(Uint64,0x0010000000000000))
    realmax(::Type{Float32}) = $boxf32(unbox(Uint32,0x7f7fffff))
    realmax(::Type{Float64}) = $boxf64(unbox(Uint64,0x7fefffffffffffff))
    realmin{T<:Float}(x::T) = realmin(T)
    realmax{T<:Float}(x::T) = realmax(T)
    realmin() = realmin(Float64)
    realmax() = realmax(Float64)

    nextfloat(x::Float32, i::Integer) = boxf32(add_int(unbox(Float32,x),unbox(Int32,int32(i))))
    nextfloat(x::Float64, i::Integer) = boxf64(add_int(unbox(Float64,x),unbox(Int64,int64(i))))
    nextfloat(x::Float) = nextfloat(x,1)
    prevfloat(x::Float) = nextfloat(x,-1)

    eps(x::Float) = isfinite(x) ? abs(nextfloat(x)-x) : nan(x)
    eps(::Type{Float32}) = $boxf32(unbox(Uint32,0x34000000))
    eps(::Type{Float64}) = $boxf64(unbox(Uint64,0x3cb0000000000000))
    eps() = eps(Float64)
end
...
bswap(x::Float32) = boxf32(bswap_int(unbox(Float32,x)))
bswap(x::Float64) = boxf64(bswap_int(unbox(Float64,x)))
