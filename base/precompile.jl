...
precompile(Base.REPL.display, (Base.REPL.REPLDisplay{Base.REPL.LineEditREPL}, Base.Multimedia.MIMESymbol("text/plain")}, Int))
...
precompile(Base.writemime, (Base.Terminals.TTYTerminal, Base.Multimedia.MIMESymbol("text/plain")}, Int))
