...
precompile(Tuple{typeof(Core.Inference.iteratorsize), Core.Inference.Generator{Tuple{Nothing}, Type{Core.Inference.Const}}})
precompile(Tuple{typeof(Core.Inference.iteratorsize), Type{Core.Inference.Generator{Tuple{Nothing}, Type{Core.Inference.Const}}}})
precompile(Tuple{typeof(Core.Inference.iteratorsize), Type{Tuple{Nothing}}})
...
precompile(Tuple{typeof(Base.Sort.findsortedfirst), String, Array{String, 1}, Int64, Int64, Base.Order.ForwardOrdering})
precompile(Tuple{typeof(Base.Sort.findsortedlast), String, Array{String, 1}, Int64, Int64, Base.Order.ForwardOrdering})
precompile(Tuple{typeof(Base.Sort.findsorted), String, Array{String, 1}, Int64, Int64, Base.Order.ForwardOrdering})
precompile(Tuple{typeof(Base.Sort.findsorted), String, Array{String, 1}, Base.Order.ForwardOrdering})
