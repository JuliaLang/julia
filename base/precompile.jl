...
precompile(Base.Multimedia.TextDisplay, (Base.Streams.TTY,))
...
precompile(Base.Multiprocessing.RemoteRef, (Int, Int, Int))
precompile(Base.Multiprocessing.RemoteValue, ())
precompile(Base.Set, ())
precompile(Base.SystemError, (ASCIIString,))
precompile(Base.Sockets.TCPSocket, (Ptr{Void},))
precompile(Base.Streams.TTY, (Ptr{Void},))
precompile(Base.Terminals.TTYTerminal, (ASCIIString, Base.Streams.TTY, Base.Streams.TTY, Base.Streams.TTY))
...
precompile(Base.Streams._uv_hook_alloc_buf, (Base.Streams.TTY, UInt))
precompile(Base.Streams._uv_hook_readcb, (Base.Streams.TTY, Int, Ptr{Void}, UInt))
precompile(Base.Streams._uv_hook_writecb_task, (Base.Streams.TTY, Ptr{Void}, Int32))
...
precompile(Base.Processes.arg_gen, (ASCIIString,))
precompile(Base.Streams.associate_julia_struct, (Ptr{Void}, Base.Streams.TTY))
...
precompile(Base.close, (Base.Streams.TTY,))
...
precompile(Base.convert, (Type{Base.Sockets.IPAddr}, Base.Sockets.IPv4))
...
precompile(Base.Poll.fdwatcher_init, ())
precompile(Base.fill!, (BitArray{1}, Bool))
precompile(Base.first, (UnitRange{Int},))
precompile(Base.flush, (IOStream,))
precompile(Base.Multiprocessing.flush_gc_msgs, ())
precompile(Base.Multiprocessing.flush_gc_msgs, (Base.Multiprocessing.Worker,))
...
precompile(Base.Streams.init_stdio, (Ptr{Void},))
...
precompile(Base.Multiprocessing.notify_empty, (Base.Multiprocessing.RemoteValue,))
precompile(Base.Multiprocessing.notify_full, (Base.Multiprocessing.RemoteValue,))
...
precompile(Base.print, (Base.Streams.TTY, ASCIIString))
precompile(Base.print, (Base.Streams.TTY,Char))
...
precompile(Base.println, (Base.Streams.TTY,))
...
precompile(Base.Streams.reinit_stdio, ())
...
precompile(Base.Multiprocessing.rr2id, (RemoteRef,))
...
precompile(Base.Streams.start_reading, (Base.Streams.TTY,))
precompile(Base.Streams.stop_reading, (Base.Streams.TTY,))
...
precompile(Base.take!, (Base.Multiprocessing.RemoteValue,))
precompile(Base.take!, (RemoteRef,))
precompile(Base.Multiprocessing.take_ref, ((Int,Int),))
precompile(Base.takebuf_string, (IOBuffer,))
precompile(Base.task_local_storage, ())
precompile(Base.Multiprocessing.terminate_all_workers, ())
...
precompile(Base.Streams.uv_error, (ASCIIString, Bool))
precompile(Base.Streams.uvfinalize, (Base.Streams.TTY,))
precompile(Base.vcat, (Base.LineEdit.Prompt,))
precompile(Base.wait, ())
precompile(Base.wait, (RemoteRef,))
precompile(Base.Multiprocessing.wait_empty, (Base.Multiprocessing.RemoteValue,))
precompile(Base.Multiprocessing.wait_full, (Base.Multiprocessing.RemoteValue,))
precompile(Base.Multiprocessing.work_result, (Base.Multiprocessing.RemoteValue,))
...
precompile(Base.setindex!, (Dict{Any, Any}, Base.Multiprocessing.RemoteValue, (Int, Int)))
precompile(Base.setindex!, (Dict{ByteString, VersionNumber}, VersionNumber, ASCIIString))
precompile(Base.spawn, (Cmd, (Base.Streams.TTY, Base.Streams.TTY, Base.Streams.TTY), Bool, Bool))
...
precompile(Base.Multiprocessing.take_ref, (Tuple{Int64, Int64},))
precompile(Base.get, (Base.Dict{Any, Any}, Tuple{Int64, Int64}, Bool))
precompile(Base.setindex!, (Base.Dict{Any, Any}, Base.Multiprocessing.RemoteValue, Tuple{Int64, Int64}))
...
precompile(Base.Multiprocessing.send_del_client, (Base.RemoteRef,))
