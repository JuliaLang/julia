...
precompile(Base.RemoteChannelStore, ())
precompile(Base.Set, ())
...
precompile(Base.rr2id, (RemoteChannel,))
...
precompile(Base.take!, (Base.RemoteChannelStore,))
...
precompile(Base.wait, (Base.RemoteChannelStore,))
precompile(Base.fetch, (Base.RemoteChannelStore,))
...
precompile(Base.setindex!, (Dict{Any, Any}, Base.RemoteChannelStore, (Int, Int)))
