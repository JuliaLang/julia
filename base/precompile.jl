...
precompile(Tuple{typeof(Core.Compiler.isbits), Base.LineEdit.EmptyCompletionProvider})
precompile(Tuple{typeof(Core.Compiler.isbits), Base.LineEdit.EmptyHistoryProvider})
...
precompile(Tuple{typeof(Core.Compiler.isbits), Base.REPL.REPLCompletionProvider})
precompile(Tuple{getfield(Core, Symbol("#kw#Type")), Array{Any, 1}, Type{Base.LineEdit.Prompt}, String})
precompile(Tuple{typeof(Core.Compiler.isbits), Base.REPL.ShellCompletionProvider})
...
precompile(Tuple{typeof(Core.Compiler.isbits), Base.REPL.LatexCompletions})
...
precompile(Tuple{typeof(Core.Compiler.isbits), Tuple{Int64, Base.Regex}})
...
precompile(Tuple{typeof(Core.Compiler.isbits), Base.Markdown.HorizontalRule})
...
precompile(Tuple{typeof(Core.Compiler.eltype), Type{Array{T, 2} where T}})
