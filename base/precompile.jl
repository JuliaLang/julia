...
precompile(Terminals.UnixTerminal, (ASCIIString, TTY, TTY, TTY))
precompile(isequal, (Nothing, Nothing))
precompile(banner, (Terminals.UnixTerminal, Terminals.UnixTerminal))
precompile(banner, (Terminals.UnixTerminal,))
...
precompile(print, (Terminals.UnixTerminal, ASCIIString))
precompile(-, (Int,))
precompile(_setindex!, (Dict{Any, Any}, Bool, WeakRef, Int))
precompile(REPL.LineEditREPL, (Terminals.UnixTerminal,))
...
precompile(REPL.LineEditREPL,
           (Terminals.UnixTerminal, ASCIIString, ASCIIString, ASCIIString, ASCIIString, ASCIIString, Bool, Bool, Bool, Int))
...
precompile(LineEdit.run_interface, (Terminals.UnixTerminal, LineEdit.ModalInterface))
precompile(LineEdit.prompt!, (Terminals.UnixTerminal, LineEdit.ModalInterface, LineEdit.MIState))
precompile(Terminals.raw!, (Terminals.UnixTerminal, Bool))
precompile(start_reading, (TTY,))
precompile(stop_reading, (TTY,))
precompile(LineEdit.activate, (LineEdit.Prompt, LineEdit.PromptState))
precompile(size, (Terminals.UnixTerminal,))
precompile(uv_error, (ASCIIString, Bool))
precompile(LineEdit.clear_input_area, (Terminals.UnixTerminal, LineEdit.InputAreaState))
...
precompile(LineEdit.write_prompt, (Terminals.UnixTerminal, LineEdit.PromptState, ASCIIString))
...
precompile(setindex!, (Array{LineEdit.TextInterface, 1}, LineEdit.Prompt, Range1{Int}))
precompile(setindex!, (Array{LineEdit.TextInterface, 1}, LineEdit.HistoryPrompt, Range1{Int}))
...
precompile(LineEdit.init_state, (Terminals.UnixTerminal, LineEdit.Prompt))
...
precompile(LineEdit.init_state, (Terminals.UnixTerminal, LineEdit.HistoryPrompt))
