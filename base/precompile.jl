...
precompile(!=, (SubString{UTF8String}, UTF8String))
precompile(*, (UTF8String, UTF8String, UTF8String))
precompile(-, (Int,))
precompile(==, (UTF8String, UTF8String))
precompile(==, (UTF8String, Char))
precompile(==, (UTF8String, Int))
...
precompile(Base.IOStream, (UTF8String, Array{UInt8,1}))
precompile(Base.KeyError, (Int,))
precompile(Base.LineEdit.Prompt, (UTF8String, UTF8String, UTF8String, Function, Function, Base.REPL.LineEditREPL, Base.REPL.REPLCompletionProvider, Function, Function, Base.LineEdit.EmptyHistoryProvider, Bool))
precompile(Base.LineEdit.Prompt, (UTF8String, UTF8String, UTF8String, Function, Function, Base.REPL.LineEditREPL, Base.REPL.ShellCompletionProvider, Function, Function, Base.LineEdit.EmptyHistoryProvider, Bool))
precompile(Base.LineEdit.Prompt, (UTF8String, UTF8String, Function, Function, Base.REPL.LineEditREPL, Base.REPL.REPLCompletionProvider, Function, Function, Base.LineEdit.EmptyHistoryProvider, Bool, UTF8String))
precompile(Base.LineEdit.Prompt, (UTF8String, UTF8String, Function, Function, Base.REPL.LineEditREPL, Base.REPL.ShellCompletionProvider, Function, Function, Base.LineEdit.EmptyHistoryProvider, Bool, UTF8String))
...
precompile(Base.LineEdit.edit_insert, (IOBuffer, UTF8String))
...
precompile(Base.LineEdit.keymap_fcn, (Function, UTF8String))
...
precompile(Base.LineEdit.replace_line, (Base.LineEdit.PromptState, UTF8String))
...
precompile(Base.LineEdit.splice_buffer!, (IOBuffer, UnitRange{Int}, UTF8String))
...
precompile(Base.REPL.LineEditREPL, (Base.Terminals.TTYTerminal, Bool, UTF8String, UTF8String, UTF8String, UTF8String, UTF8String, Bool, Bool, Bool, Bool))
...
precompile(Base.REPL.ends_with_semicolon, (UTF8String,))
...
precompile(Base.REPLCompletions.complete_methods, (UTF8String,))
precompile(Base.REPLCompletions.complete_symbol, (UTF8String, Function))
precompile(Base.REPLCompletions.completions, (UTF8String, Int))
precompile(Base.Random.srand, ())
precompile(Base.Random.srand, (UTF8String, Int))
precompile(Base.Random.srand, (UInt,))
precompile(Base.RemoteChannel, (Int, Int, Int))
precompile(Base.RemoteValue, ())
precompile(Base.Set, ())
precompile(Base.SystemError, (UTF8String,))
precompile(Base.TCPSocket, (Ptr{Void},))
precompile(Base.TTY, (Ptr{Void},))
precompile(Base.Terminals.TTYTerminal, (UTF8String, Base.TTY, Base.TTY, Base.TTY))
...
precompile(Base.VersionNumber, (Int, Int, Int, Tuple{}, Tuple{UTF8String}))
...
precompile(Base.startswith, (UTF8String, UTF8String))
precompile(Base.bytestring, (UTF8String,))
precompile(Base.chop, (UTF8String,))
...
precompile(Base.convert, (Type{AbstractString}, UTF8String))
...
precompile(Base.get, (Base.EnvHash, UTF8String, UTF8String))
precompile(Base.get, (Dict{Any, Any}, Tuple{Int, Int}, Bool))
precompile(Base.get, (Dict{Any,Any}, Symbol, UTF8String))
...
precompile(Base.getindex, (Type{ByteString}, UTF8String, UTF8String))
...
precompile(Base.haskey, (Base.EnvHash, UTF8String))
...
precompile(Base.in, (Char, UTF8String))
...
precompile(Base.isabspath, (UTF8String,))
precompile(Base.isempty, (UTF8String,))
...
precompile(Base.isempty, (SubString{UTF8String},))
...
precompile(Base.isequal, (Char, UTF8String))
...
precompile(Base.isfile, (UTF8String,))
precompile(Base.ismatch, (Regex, UTF8String))
precompile(Base.isslotempty, (Dict{Any,Any}, Int))
precompile(Base.istaskdone, (Task,))
precompile(Base.joinpath, (UTF8String, UTF8String))
precompile(Base.joinpath, (UTF8String, UTF8String, UTF8String))
precompile(Base.keys, (Dict{UInt8, Any},))
precompile(Base.last, (UnitRange{Int},))
precompile(Base.length, (UTF8String,))
...
precompile(Base.nextind, (UTF8String, Int))
precompile(Base.normpath, (UTF8String, UTF8String))
precompile(Base.normpath, (UTF8String,))
precompile(Base.notify, (Condition, Any))
precompile(Base.open, (UTF8String, UTF8String))
precompile(Base.parse_input_line, (UTF8String,))
precompile(Base.parse, (Type{Int}, UTF8String, Int))
...
precompile(Base.print, (UTF8String,))
precompile(Base.print, (Base.TTY, UTF8String))
precompile(Base.print, (Base.TTY,Char))
precompile(Base.print, (Base.Terminals.TTYTerminal, UTF8String))
precompile(Base.print, (Base.Terminals.TTYTerminal, UTF8String, Char))
precompile(Base.print, (Base.Terminals.TTYTerminal, UTF8String, Char,))
...
precompile(Base.print, (IOStream,UTF8String))
precompile(Base.print_joined, (IOBuffer, Tuple{UTF8String}, Char))
precompile(Base.print_joined, (IOBuffer, Tuple{Int}, Char))
precompile(Base.print_joined, (IOBuffer, Array{UTF8String,1}, Char))
precompile(Base.print_joined, (IOBuffer, Array{AbstractString,1}, UTF8String))
precompile(Base.print_joined, (IOBuffer, Array{SubString{UTF8String}, 1}, UTF8String))
...
precompile(Base.push!, (Array{Union{UTF8String, UTF8String}, 1}, UTF8String))
...
precompile(Base.readline, (UTF8String,))
...
precompile(Base.repeat, (UTF8String, Int))
...
precompile(Base.rsearch, (UTF8String, Char))
precompile(Base.rstrip, (UTF8String,))
precompile(Base.run, (Cmd,))
precompile(Base.search, (UTF8String, Regex, Int))
precompile(Base.search, (IOBuffer, UInt8))
precompile(Base.seek, (IOBuffer, Int))
precompile(Base.seekend, (IOStream,))
precompile(Base.setindex!, (Array{AbstractString, 1}, UTF8String, Int))
...
precompile(Base.setindex!, (Base.EnvHash, UTF8String, UTF8String))
...
precompile(Base.sizeof, (UTF8String,))
precompile(Base.source_path, (Void,))
precompile(Base.splice!, (Array{UInt8, 1}, Base.UnitRange{Int}, Array{UInt8, 1}))
precompile(Base.split, (UTF8String, UTF8String))
precompile(Base.split, (UTF8String, Regex))
precompile(Base.split, (UTF8String,))
...
precompile(Libc.strftime, (UTF8String, Libc.TmStruct))
precompile(Base.string, (Int,))
precompile(Base.strip, (UTF8String,))
precompile(Base.strwidth, (UTF8String,))
...
precompile(Base.try_include, (UTF8String,))
...
precompile(Base.uv_error, (UTF8String, Bool))
...
precompile(Base.write, (Base.Terminals.TTYTerminal, UTF8String))
precompile(Base.write, (Base.Terminals.TerminalBuffer, UTF8String))
...
precompile(Base.Pkg.Entry.update, (UTF8String,))
...
precompile(Base.Pkg.Read.installed_version, (UTF8String, Dict{VersionNumber, Base.Pkg.Types.Available}))
...
precompile(Base.info, (UTF8String,))
precompile(Base.isempty, (Array{Void, 1},))
precompile(Base.setindex!, (Dict{ByteString, VersionNumber}, VersionNumber, UTF8String))
...
precompile(Base.convert, (Type{UTF8String}, ASCIIString))
...
precompile(!=, (Base.SubString{UTF8String}, UTF8String))
precompile(Base.print_joined, (Base.IOBuffer, Array{Base.SubString{UTF8String}, 1}, UTF8String))
precompile(Base.joinpath, (UTF8String, UTF8String, UTF8String, UTF8String))
precompile(Base.string, (UTF8String, UTF8String, Char))
precompile(Base.string, (UTF8String, UTF8String, Int))
precompile(Base.vect, (Base.LineEdit.Prompt, UTF8String))
