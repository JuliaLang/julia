...
precompile(Base.Random.srand, (Uint64,))
...
precompile(==, (Type{((Int64, Int64), ASCIIString, Type{Any})}, Int64))
precompile(==, (Type{(Base.LineEdit.HistoryPrompt{Base.REPL.REPLHistoryProvider}, ASCIIString, Type{Any})}, Int64))
precompile(==, (Type{ASCIIString}, Type{Any}))
precompile(==, (Type{Function}, Int64))
...
precompile(Base._deleteat!, (Array{Uint8, 1}, Int64, Int64))
precompile(Base._deleteat_beg!, (Array{Uint8, 1}, Int64, Int64))
precompile(Base._deleteat_end!, (Array{Uint8, 1}, Int64, Int64))
precompile(Base._growat_beg!, (Array{Uint8, 1}, Int64, Int64))
precompile(Base._growat_end!, (Array{Uint8, 1}, Int64, Int64))
...
precompile(Base._uv_hook_alloc_buf, (Base.TTY, Uint64))
precompile(Base._uv_hook_readcb, (Base.TTY, Int64, Ptr{Void}, Uint64))
...
precompile(Base.convert, (Type{Any}, Int64))
...
precompile(Base.deleteat!, (Array{Uint8, 1}, Base.UnitRange{Int64}))
...
precompile(Base.done, (IntSet, Int64))
precompile(Base.done, (UnitRange{Int},Int))
#precompile(Base.effect_free, (Expr,))
#precompile(Base.effect_free, (TopNode,))
...
precompile(Base.get, (Dict{Any, Any}, (Int64, Int64), Bool))
...
precompile(Base.in, (Int64, Base.UnitRange{Int64}))
...
precompile(Base.insert!, (Array{Any,1}, Int64, Base.GetfieldNode))
precompile(Base.int, (Int,))
precompile(Base.int, (Uint64,))
...
precompile(Base.next, (IntSet, Int64))
...
precompile(Base.print_joined, (IOBuffer, (Int64,), Char))
precompile(Base.print_joined, (IOBuffer, Array{ASCIIString,1}, Char))
precompile(Base.print_joined, (IOBuffer, Array{String,1}, ASCIIString))
...
precompile(Base.setindex!, (Array{String, 1}, ASCIIString, Int64))
precompile(Base.setindex!, (Array{Symbol, 1}, Symbol, Int64))
...
precompile(Base.show, (Base.Terminals.TTYTerminal, Int64))
precompile(Base.show, (Float64,))
precompile(Base.show, (IOStream, Int32))
precompile(Base.showlimited, (Base.Terminals.TTYTerminal, Int64))
...
precompile(Base.splice!, (Array{Uint8, 1}, Base.UnitRange{Int64}, Array{Uint8, 1}))
...
precompile(Base.writemime, (Base.Terminals.TTYTerminal, Base.Multimedia.MIME{symbol("text/plain")}, Int64))
...
precompile(Base.LineEdit.activate, (Base.LineEdit.Prompt, Base.LineEdit.MIState, Base.Terminals.TTYTerminal))
#precompile(Base.LineEdit.activate, (Base.LineEdit.Prompt, Base.LineEdit.PromptState))
...
#precompile(Base.LineEdit.reset_state, (Base.LineEdit.Prompt,))
...
precompile(Base.LineEdit.splice_buffer!, (IOBuffer, UnitRange{Int64}, ASCIIString))
...
precompile(Base.LineEdit.write_prompt, (Base.Terminals.TerminalBuffer, Base.LineEdit.PromptState, ASCIIString))
...
precompile(Base.REPLCompletions.shell_completions, (ASCIIString, Int))
...
precompile(Base.REPL.display, (Base.REPL.REPLDisplay{Base.REPL.LineEditREPL}, Base.Multimedia.MIME{symbol("text/plain")}, Int64))
precompile(Base.REPL.display, (Base.REPL.REPLDisplay{Base.REPL.LineEditREPL}, Int64))
...
precompile(Base.Multimedia.display, (Int64,))
...
precompile(Base.Sort.sort!, (Array{VersionNumber, 1}, Int64, Int64, Base.Sort.InsertionSortAlg, Base.Order.ForwardOrdering))
precompile(Base.info, (ASCIIString,))
precompile(Base.isempty, (Array{Void, 1},))
precompile(Base.setindex!, (Dict{Any, Any}, Base.RemoteValue, (Int64, Int64)))
