...
precompile(Tuple{typeof(Base.Iter.zip), Array{Int64, 1}, SimpleVector})
precompile(Tuple{typeof(Base.Iter.zip), Array{Symbol, 1}, SimpleVector})
precompile(Tuple{typeof(Base.start), Base.Iter.Zip2{Array{Int64, 1}, SimpleVector}})
precompile(Tuple{typeof(Base.start), Base.Iter.Zip2{Array{Symbol, 1}, SimpleVector}})
precompile(Tuple{typeof(Base.done), Base.Iter.Zip2{Array{Int64, 1}, SimpleVector}, Tuple{Int64, Int64}})
precompile(Tuple{typeof(Base.done), Base.Iter.Zip2{Array{Symbol, 1}, SimpleVector}, Tuple{Int64, Int64}})
precompile(Tuple{typeof(Base.next), Base.Iter.Zip2{Array{Int64, 1}, SimpleVector}, Tuple{Int64, Int64}})
precompile(Tuple{typeof(Base.next), Base.Iter.Zip2{Array{Symbol, 1}, SimpleVector}, Tuple{Int64, Int64}})
