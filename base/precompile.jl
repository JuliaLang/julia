...
precompile(notify_full, (ChannelBuffer,))
precompile(notify_empty, (ChannelBuffer,))
precompile(work_result, (ChannelBuffer,))
precompile(take, (ChannelBuffer,))
precompile(wait_full, (ChannelBuffer,))
...
precompile(bool, (Channel,))
precompile(wait, (Channel,))
precompile(hash, (Channel,))
precompile(take, (Channel,))
...
precompile(rr2id, (Channel,))
precompile(isequal, (Channel, WeakRef))
precompile(isequal, (Channel, Channel))
...
precompile(Channel, (Int, Int, Int))
