...
precompile(Tuple{typeof(Base.hasindex), Base.Dict{Any, Any}, Base.LineEdit.Prompt})
...
precompile(Tuple{typeof(Base.hasindex), Base.Dict{Any, Any}, Base.LineEdit.PrefixHistoryPrompt{Base.REPL.REPLHistoryProvider}})
...
precompile(Tuple{typeof(Base.hasindex), Base.ObjectIdDict, Base.Docs.Binding})
