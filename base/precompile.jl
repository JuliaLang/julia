...
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{IO}, Void}}})
precompile(Tuple{Type{Base.Union{Some{IO}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{AbstractString}, Void}}})
precompile(Tuple{Type{Base.Union{Some{AbstractString}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Integer}, Void}}})
precompile(Tuple{Type{Base.Union{Some{Integer}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Union{Int64, Symbol}}, Void}}})
precompile(Tuple{Type{Base.Union{Some{Union{Int64, Symbol}}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Base.Cmd}, Void}}})
precompile(Tuple{Type{Base.Union{Some{Base.Cmd}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Any}, Void}}})
precompile(Tuple{Type{Base.Union{Some{Any}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Bool}, Void}}})
precompile(Tuple{Type{Base.Union{Some{Bool}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Base.Process}, Void}}})
precompile(Tuple{Type{Base.Union{Some{Base.Process}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Base.Dict{K, V}}, Void} where V where K}})
precompile(Tuple{Type{Base.Union{Some{Base.Dict{K, V}}, Void} where V where K}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Array{T, N}}, Void} where N where T}})
precompile(Tuple{Type{Base.Union{Some{Array{T, N}}, Void} where N where T}})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.Process}, Void}}, Base.Process})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Bool}, Void}}, Bool})
...
precompile(Tuple{typeof(Base.unpreserve_handle), Base.Timer})
precompile(Tuple{typeof(Base.disassociate_julia_struct), Base.Timer})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{AbstractString}, Void}}, Base.SubString{String}})
...
precompile(Tuple{typeof(Base.print), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.TCPSocket})
precompile(Tuple{typeof(Base.isopen), Base.TCPSocket})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{AbstractString}, Void}}, String})
precompile(Tuple{typeof(Base.unpreserve_handle), Base.TCPSocket})
precompile(Tuple{typeof(Base.check_open), Base.TCPSocket})
precompile(Tuple{typeof(Base.stream_wait), Base.TCPSocket, Base.Condition})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.VersionNumber}, Void}}, Base.Union{Some{Base.VersionNumber}, Void}})
...
precompile(Tuple{Type{Base.Union{Some{Array{T, N}}, Void} where N where T}})
precompile(Tuple{typeof(Base.convert), Type{IO}, Base.TCPSocket})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.VersionNumber}, Void}}, Base.VersionNumber})
precompile(Tuple{typeof(Base.unsafe_write), Base.TCPSocket, Ptr{UInt8}, UInt64})
precompile(Tuple{typeof(Base.uv_write), Base.TCPSocket, Ptr{UInt8}, UInt64})
precompile(Tuple{typeof(Base.flush), Base.TCPSocket})
precompile(Tuple{typeof(Base.write), Base.TCPSocket, Int64, Int64, Int64, Int64})
...
precompile(Tuple{typeof(Base.get), Base.Union{Some{Base.Dict{K, V}}, Void} where V where K, Base.Dict{Any, Any}})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.Dict{K, V}}, Void} where V where K}, Base.Dict{Any, Any}})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Integer}, Void}}, Int64})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.VersionNumber}, Void}}, Base.VersionNumber})
