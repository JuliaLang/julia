...
precompile(Tuple{typeof(Core.Inference.isbits), Tuple{Nothing, Bool}})
precompile(Tuple{typeof(Base._convert), Type{Array{Method, 1}}, Base.BitArray{1}})
precompile(Tuple{typeof(Base.unsafe_copyto!), Array{Method, 1}, Int64, Array{Method, 1}, Int64, Int64})
