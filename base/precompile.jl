...
precompile(Tuple{typeof(Base.unsafe_copyto!), Array{Ptr{Void}, 1}, Int64, Array{Ptr{Void}, 1}, Int64, Int64})
...
precompile(Tuple{typeof(Core.Inference.copyto!), Array{Any, 1}, Core.Inference.Generator{Tuple{Void}, Type{Core.Inference.Const}}})
...
precompile(Tuple{typeof(getindex), Base._ObjectIdDict, Type{Tuple{Any}}})
...
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{IO, Void}}})
precompile(Tuple{Type{Base.Union{IO, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{AbstractString, Void}}})
precompile(Tuple{Type{Base.Union{AbstractString, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Integer, Void}}})
precompile(Tuple{Type{Base.Union{Integer, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Int64, Symbol, Void}}})
precompile(Tuple{Type{Base.Union{Int64, Symbol, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Base.Cmd, Void}}})
precompile(Tuple{Type{Base.Union{Base.Cmd, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Any}, Void}}})
precompile(Tuple{Type{Base.Union{Some{Any}, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Bool, Void}}})
precompile(Tuple{Type{Base.Union{Bool, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Base.Process, Void}}})
precompile(Tuple{Type{Base.Union{Base.Process, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Base.Dict{K, V}, Void} where V where K}})
precompile(Tuple{Type{Base.Union{Base.Dict{K, V}, Void} where V where K}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Array{T, N}, Void} where N where T}})
precompile(Tuple{Type{Base.Union{Array{T, N}, Void} where N where T}})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Base.Process, Void}}, Base.Process})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Bool, Void}}, Bool})
...
precompile(Tuple{typeof(Base.unpreserve_handle), Base.Timer})
precompile(Tuple{typeof(Base.disassociate_julia_struct), Base.Timer})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{AbstractString, Void}}, Base.SubString{String}})
...
precompile(Tuple{typeof(Base.print), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.TCPSocket})
precompile(Tuple{typeof(Base.isopen), Base.TCPSocket})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{AbstractString, Void}}, String})
precompile(Tuple{typeof(Base.unpreserve_handle), Base.TCPSocket})
precompile(Tuple{typeof(Base.check_open), Base.TCPSocket})
precompile(Tuple{typeof(Base.stream_wait), Base.TCPSocket, Base.Condition})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Base.VersionNumber, Void}}, Base.Union{Base.VersionNumber, Void}})
...
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Integer, Void}}})
precompile(Tuple{Type{Base.Union{Integer, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Union{Int64, Symbol}}, Void}}})
precompile(Tuple{Type{Base.Union{Int64, Symbol, Void}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Base.Cmd, Void}}})
precompile(Tuple{Type{Base.Union{Base.Cmd, Void}}})
...
precompile(Tuple{Type{Base.Union{Array{T, N}, Void} where N where T}})
precompile(Tuple{typeof(Base.convert), Type{IO}, Base.TCPSocket})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Base.VersionNumber, Void}}, Base.VersionNumber})
precompile(Tuple{typeof(Base.unsafe_write), Base.TCPSocket, Ptr{UInt8}, UInt64})
precompile(Tuple{typeof(Base.uv_write), Base.TCPSocket, Ptr{UInt8}, UInt64})
precompile(Tuple{typeof(Base.flush), Base.TCPSocket})
precompile(Tuple{typeof(Base.write), Base.TCPSocket, Int64, Int64, Int64, Int64})
...
precompile(Tuple{typeof(Base.get), Base.Union{Base.Dict{K, V}, Void} where V where K, Base.Dict{Any, Any}})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Base.Dict{K, V}, Void} where V where K}, Base.Dict{Any, Any}})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Integer, Void}}, Int64})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Base.VersionNumber, Void}}, Base.VersionNumber})
...
precompile(Tuple{typeof(getindex), Base._ObjectIdDict, Symbol})
