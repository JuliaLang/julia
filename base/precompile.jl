...
precompile(Tuple{typeof(Base.getindex), Base.ObjectIdDict{Symbol,Module}, Symbol})
precompile(Tuple{typeof(Base.getindex), Base.ObjectIdDict{Module,Symbol}, Module})
precompile(Tuple{typeof(Base.getindex), Base.ObjectIdDict{Any,Int}, Module})
