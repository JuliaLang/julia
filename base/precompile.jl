...
precompile(Tuple{typeof(Base.unsafe_copy!), Array{Ptr{Cvoid}, 1}, Int64, Array{Ptr{Cvoid}, 1}, Int64, Int64})
...
precompile(Tuple{typeof(Core.Inference.copy!), Array{Any, 1}, Core.Inference.Generator{Tuple{Nothing}, Type{Core.Inference.Const}}})
