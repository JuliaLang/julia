...
for use in [`Mmap.mmap`](:func:`mmap`).
Used by [`SharedArray`](:obj:`SharedArray`) for creating shared memory arrays.
"""
...
"""
    Mmap.mmap(io::IO, type::Type{Array{T,N}}=Vector{UInt8}, dims::NTuple{N,Integer}, offset::Integer=position(io); grow::Bool=true, shared::Bool=true)
...
"""
    Mmap.mmap(io::IOStream, BitArray, dims::NTuple{N,Integer}, offset::Int64=position(io); grow::Bool=true, shared::Bool=true)
