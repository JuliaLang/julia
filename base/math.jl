...
For very high order polynomials, or polynomials whose length is not known at compile
time, this function will fail to inline and the performance of this function will suffer.
"""
horner(x) = zero(x)
horner(x, p1) = p1
