...
getindex(t::Tuple, r::AbstractVector) = tuple([t[ri] for ri in r]...)
getindex(t::Tuple, b::AbstractVector{Bool}) = length(b) == length(t) ? getindex(t,find(b)) : throw(BoundsError(t, b))
