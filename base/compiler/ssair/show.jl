...
function Base.show(io::IO, e::Effects)
    ...
    print(io, ',')
    printstyled(io, effectbits_letter(e, :no_throw,     'n'); color=effectbits_color(e, :no_throw))
    print(io, ',')
    printstyled(io, effectbits_letter(e, :terminates,  't'); color=effectbits_color(e, :terminates))
    print(io, ',')
    printstyled(io, effectbits_letter(e, :no_task_state, 's'); color=effectbits_color(e, :no_task_state))
    print(io, ',')
    printstyled(io, effectbits_letter(e, :inaccessible_mem_only, 'm'); color=effectbits_color(e, :inaccessible_mem_only))
    print(io, ',')
    printstyled(io, effectbits_letter(e, :no_ub, 'u'); color=effectbits_color(e, :no_ub))
    print(io, ')')
    e.non_overlayed || printstyled(io, '′'; color=:red)
end
