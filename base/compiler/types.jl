...
mutable struct InferenceResult
    ...
    function InferenceResult(interp::AbstractInterpreter, linfo::MethodInstance, given_argtypes = nothing, va_override=false)
        argtypes, overridden_by_const = matching_cache_argtypes(interp, linfo, given_argtypes, va_override)
