...
This query is specifically written for analyzing the `:inaccessible_mem_only` effect property
and is supposed to improve the analysis accuracy by not tainting the `:inaccessible_mem_only`
