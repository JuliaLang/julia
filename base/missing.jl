...
convert(::Type{Any}, x::Missing) = x
#convert(::Type{Union{Nothing, Missing}}, x::Union{Nothing, Missing}) = x
convert(::Type{Union{T, Missing}}, x::Missing) where {T} = x
convert(::Type{Union{Nothing, Missing, T}}, x::Nothing) where {T} = x
convert(::Type{Union{Nothing, Missing, T}}, x::Missing) where {T} = x
