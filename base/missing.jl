...
<(::Missing, ::Any) = missing
<(::Any, ::Missing) = missing
<(::Missing, ::Nothing) = throw(MethodError(<, (missing, nothing)))
<(::Nothing, ::Missing) = throw(MethodError(<, (nothing, missing)))
isless(::Missing, ::Missing) = false
isless(::Missing, ::Any) = false
isless(::Any, ::Missing) = true
isless(::Missing, ::Nothing) = true
isless(::Nothing, ::Missing) = false
