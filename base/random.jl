...
## random Char values
## (ranges autogenerated from is_valid_char(::Char))
function rand(r::AbstractRNG, ::Type{Char})
    v = rand(0x00000000:0x0010f7bd)
    if v < 0x0007f7d0
        if v < 0x0003f7d8
            if v < 0x0001f7dc
                if v < 0x0000f7de
                    if v < 0x0000d800
                        return Char((v - 0x00000000) + 0x00000000)
                    else
                        if v < 0x0000f5d0
                            return Char((v - 0x0000d800) + 0x0000e000)
                        else
                            return Char((v - 0x0000f5d0) + 0x0000fdf0)
                        end
                    end
                else
                    return Char((v - 0x0000f7de) + 0x00010000)
                end
            else
                if v < 0x0002f7da
                    return Char((v - 0x0001f7dc) + 0x00020000)
                else
                    return Char((v - 0x0002f7da) + 0x00030000)
                end
            end
        else
            if v < 0x0005f7d4
                if v < 0x0004f7d6
                    return Char((v - 0x0003f7d8) + 0x00040000)
                else
                    return Char((v - 0x0004f7d6) + 0x00050000)
                end
            else
                if v < 0x0006f7d2
                    return Char((v - 0x0005f7d4) + 0x00060000)
                else
                    return Char((v - 0x0006f7d2) + 0x00070000)
                end
            end
        end
    else
        if v < 0x000bf7c8
            if v < 0x0009f7cc
                if v < 0x0008f7ce
                    return Char((v - 0x0007f7d0) + 0x00080000)
                else
                    return Char((v - 0x0008f7ce) + 0x00090000)
                end
            else
                if v < 0x000af7ca
                    return Char((v - 0x0009f7cc) + 0x000a0000)
                else
                    return Char((v - 0x000af7ca) + 0x000b0000)
                end
            end
        else
            if v < 0x000df7c4
                if v < 0x000cf7c6
                    return Char((v - 0x000bf7c8) + 0x000c0000)
                else
                    return Char((v - 0x000cf7c6) + 0x000d0000)
                end
            else
                if v < 0x000ef7c2
                    return Char((v - 0x000df7c4) + 0x000e0000)
                else
                    if v < 0x000ff7c0
                        return Char((v - 0x000ef7c2) + 0x000f0000)
                    else
                        return Char((v - 0x000ff7c0) + 0x00100000)
                    end
                end
            end
        end
    end
    error("$v not a valid Char")
end
