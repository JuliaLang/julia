...
@inline ACOS_CORRECT_LOWWORD(::Type{Float32}, x) = reinterpret(Float32, and(reinterpret(UInt32, x), 0xfffff000))
...
function mulpi_ext(x::Float64)
    ...
    x_hi = reinterpret(Float64, and(reinterpret(UInt64,x), 0xffff_ffff_f800_0000))
    x_lo = x-x_hi
