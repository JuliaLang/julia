...
contents at the bit level, and immutable objects (such as strings, tuples, and non-mutable
structs) are compared field-by-field using `===`. This function is sometimes called "egal".
