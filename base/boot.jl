...
export
    ...
    # intrinsics module
    Intrinsics
    #ccall, cglobal, llvmcall, add_float, add_int, and_int, ashr_int,
    ...
    #nan_dom_err, ctlz_int, ctpop_int, cttz_int,
    ...
    #floor_llvm, log10_llvm, log2_llvm, log_llvm, maxnum_llvm, minnum_llvm,
    #nearbyint_llvm, pow_llvm, powi_llvm, rint_llvm, round_llvm, sin_llvm,
    #sqrt_llvm, trunc_llvm,
