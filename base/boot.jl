...
eval(Core, :(CodeInstance(mi::MethodInstance, @nospecialize(rettype), @nospecialize(inferred_const),
                          ...
                          min_world::UInt, max_world::UInt, relocatability::UInt8, @nospecialize(arg_escapes)) =
                ccall(:jl_new_codeinst, Ref{CodeInstance}, (Any, Any, Any, Any, Int32, UInt, UInt, UInt8, Any),
                    mi, rettype, inferred_const, inferred, const_flags, min_world, max_world, relocatability, arg_escapes)))
