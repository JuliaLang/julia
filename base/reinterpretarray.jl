...
unaliascopy(a::NonReshapedReinterpretArray{T}) where {T} = (@noinline; reinterpret(T, unaliascopy(a.parent)))
unaliascopy(a::ReshapedReinterpretArray{T}) where {T} = (@noinline; reinterpret(reshape, T, unaliascopy(a.parent)))
