...
function update(branch::String, avail::Dict=Read.available())
    ...
    updatehook(sort!([keys(Read.installed(avail))...]))
end
...
update(branch::String, pkgs::Vector) = update(branch, Read.available(pkgs))
