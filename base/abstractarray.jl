...
# define these methods, with the expectation that an offsetarray package will define a method with
# dims::Tuple{Union{Integer, UnitRange}, Vararg{Union{Integer, UnitRange}}}
