...
function finalizer(@nospecialize(f), @nospecialize(o))
    ...
    ccall(:jl_gc_add_finalizer_th, Void, (Ptr{Cvoid}, Any, Any),
          Core.getptls(), o, f)
    return o
end
...
function finalizer(f::Ptr{Cvoid}, o::T) where T
    ...
    ccall(:jl_gc_add_ptr_finalizer, Void, (Ptr{Cvoid}, Any, Ptr{Cvoid}),
          Core.getptls(), o, f)
    return o
end
...
"""
finalize(@nospecialize(o)) = ccall(:jl_finalize_th, Void, (Ptr{Cvoid}, Any,),
                                   Core.getptls(), o)
