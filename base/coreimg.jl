...
precompile(abstract_eval, (LambdaInfo, Array{Any,1}, VarInfo))
precompile(abstract_interpret, (Bool, Array{Any,1}, VarInfo))
precompile(delete_var!, (Expr, Symbol))
precompile(eval_annotate, (LambdaInfo, Array{Any,1}, VarInfo, Array{Any,1}, Array{Any,1}))
