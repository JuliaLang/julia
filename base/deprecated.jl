...
@deprecate (~)(x::BitInteger) not(x)
@deprecate (~)(n::Integer) not(x)
@deprecate (~)(x::BigInt) not(x)
@deprecate (~)(x::Bool) not(x)

@deprecate (|)(a::BigInt, b::BigInt) or(a, b)
@deprecate (|)(a::BigInt, b::BigInt, c::BigInt) or(a, b, c)
@deprecate (|)(a::BigInt, b::BigInt, c::BigInt, d::BigInt) or(a, b, c, d)
@deprecate (|)(a::BigInt, b::BigInt, c::BigInt, d::BigInt, e::BigInt) or(a, b, c, d, e)

@deprecate (|)(x::Integer) or(x)
@deprecate (|)(a::Integer, b::Integer) or(a, b)
@deprecate (|)(x::T, y::T) where {T<:Integer} or(x, y)
@deprecate (|)(x::T, y::T) where {T<:BitInteger} or(x, y)
@deprecate (|)(a, b, c, xs...) or(a, b, c, xs...)

@deprecate (&)(x::BigInt, y::BigInt) and(x, y)
@deprecate (&)(a::BigInt, b::BigInt, c::BigInt) and(a, b, c)
@deprecate (&)(a::BigInt, b::BigInt, c::BigInt, d::BigInt) and(a, b, c, d)
@deprecate (&)(a::BigInt, b::BigInt, c::BigInt, d::BigInt, e::BigInt)  and(a, b, c, d, e)

@deprecate (&)(x::Integer) and(x)
@deprecate (&)(a::Integer, b::Integer) and(a, b)
@deprecate (&)(x::T, y::T) where {T<:Integer} and(x, y)
@deprecate (&)(x::T, y::T) where {T<:BitInteger} and(x, y)
@deprecate (&)(a, b, c, xs...) and(a, b, c, xs...)

@deprecate xor(x::BigInt, y::BigInt) xor(x, y)
@deprecate xor(a::BigInt, b::BigInt, c::BigInt) xor(a, b, c)
@deprecate xor(a::BigInt, b::BigInt, c::BigInt, d::BigInt) xor(a, b, c, d)
@deprecate xor(a::BigInt, b::BigInt, c::BigInt, d::BigInt, e::BigInt) xor(a, b, c, d, e)

@deprecate xor(x::Integer) xor(x)
@deprecate xor(a::Integer, b::Integer) xor(a, b)
@deprecate xor(x::T, y::T) where {T<:Integer} xor(x, y)
@deprecate xor(x::T, y::T) where {T<:BitInteger} xor(x, y)
@deprecate xor(a, b, c, xs...) xor(a, b, c, xs...)
