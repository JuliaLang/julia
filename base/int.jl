...
convert(::Type{Int8}, x::Bool   ) = boxsi8(unbox(Int8,x))
convert(::Type{Int8}, x::Uint8  ) = boxsi8(unbox(Uint8,x))
convert(::Type{Int8}, x::Int16  ) = boxsi8(trunc8(unbox(Int16,x)))
convert(::Type{Int8}, x::Uint16 ) = boxsi8(trunc8(unbox(Uint16,x)))
convert(::Type{Int8}, x::Char   ) = boxsi8(trunc8(unbox(Char,x)))
convert(::Type{Int8}, x::Int32  ) = boxsi8(trunc8(unbox(Int32,x)))
convert(::Type{Int8}, x::Uint32 ) = boxsi8(trunc8(unbox(Uint32,x)))
convert(::Type{Int8}, x::Int64  ) = boxsi8(trunc8(unbox(Int64,x)))
convert(::Type{Int8}, x::Uint64 ) = boxsi8(trunc8(unbox(Uint64,x)))
convert(::Type{Int8}, x::Int128 ) = boxsi8(trunc8(unbox(Int128,x)))
convert(::Type{Int8}, x::Uint128) = boxsi8(trunc8(unbox(Uint128,x)))
convert(::Type{Int8}, x::Float32) = boxsi8(trunc8(fpsiround32(unbox(Float32,x))))
convert(::Type{Int8}, x::Float64) = boxsi8(trunc8(fpsiround64(unbox(Float64,x))))

convert(::Type{Uint8}, x::Bool   ) = boxui8(unbox(Uint8,x))
convert(::Type{Uint8}, x::Int8   ) = boxui8(unbox(Uint8,x))
convert(::Type{Uint8}, x::Int16  ) = boxui8(trunc8(unbox(Int16,x)))
convert(::Type{Uint8}, x::Uint16 ) = boxui8(trunc8(unbox(Uint16,x)))
convert(::Type{Uint8}, x::Char   ) = boxui8(trunc8(unbox(Char,x)))
convert(::Type{Uint8}, x::Int32  ) = boxui8(trunc8(unbox(Int32,x)))
convert(::Type{Uint8}, x::Uint32 ) = boxui8(trunc8(unbox(Uint32,x)))
convert(::Type{Uint8}, x::Int64  ) = boxui8(trunc8(unbox(Int64,x)))
convert(::Type{Uint8}, x::Uint64 ) = boxui8(trunc8(unbox(Uint64,x)))
convert(::Type{Uint8}, x::Int128 ) = boxui8(trunc8(unbox(Int128,x)))
convert(::Type{Uint8}, x::Uint128) = boxui8(trunc8(unbox(Uint128,x)))
convert(::Type{Uint8}, x::Float32) = boxui8(trunc8(fpuiround32(unbox(Float32,x))))
convert(::Type{Uint8}, x::Float64) = boxui8(trunc8(fpuiround64(unbox(Float64,x))))

convert(::Type{Int16}, x::Bool   ) = boxsi16(zext16(unbox(Bool,x)))
convert(::Type{Int16}, x::Int8   ) = boxsi16(sext16(unbox(Int8,x)))
convert(::Type{Int16}, x::Uint8  ) = boxsi16(zext16(unbox(Uint8,x)))
convert(::Type{Int16}, x::Uint16 ) = boxsi16(unbox(Uint16,x))
convert(::Type{Int16}, x::Char   ) = boxsi16(trunc16(unbox(Char,x)))
convert(::Type{Int16}, x::Int32  ) = boxsi16(trunc16(unbox(Int32,x)))
convert(::Type{Int16}, x::Uint32 ) = boxsi16(trunc16(unbox(Uint32,x)))
convert(::Type{Int16}, x::Int64  ) = boxsi16(trunc16(unbox(Int64,x)))
convert(::Type{Int16}, x::Uint64 ) = boxsi16(trunc16(unbox(Uint64,x)))
convert(::Type{Int16}, x::Int128 ) = boxsi16(trunc16(unbox(Int128,x)))
convert(::Type{Int16}, x::Uint128) = boxsi16(trunc16(unbox(Uint128,x)))
convert(::Type{Int16}, x::Float32) = boxsi16(trunc16(fpsiround32(unbox(Float32,x))))
convert(::Type{Int16}, x::Float64) = boxsi16(trunc16(fpsiround64(unbox(Float64,x))))

convert(::Type{Uint16}, x::Bool   ) = boxui16(zext16(unbox(Bool,x)))
convert(::Type{Uint16}, x::Int8   ) = boxui16(sext16(unbox(Int8,x)))
convert(::Type{Uint16}, x::Uint8  ) = boxui16(zext16(unbox(Uint8,x)))
convert(::Type{Uint16}, x::Int16  ) = boxui16(unbox(Uint16,x))
convert(::Type{Uint16}, x::Char   ) = boxui16(trunc16(unbox(Char,x)))
convert(::Type{Uint16}, x::Int32  ) = boxui16(trunc16(unbox(Int32,x)))
convert(::Type{Uint16}, x::Uint32 ) = boxui16(trunc16(unbox(Uint32,x)))
convert(::Type{Uint16}, x::Int64  ) = boxui16(trunc16(unbox(Int64,x)))
convert(::Type{Uint16}, x::Uint64 ) = boxui16(trunc16(unbox(Uint64,x)))
convert(::Type{Uint16}, x::Int128 ) = boxui16(trunc16(unbox(Int128,x)))
convert(::Type{Uint16}, x::Uint128) = boxui16(trunc16(unbox(Uint128,x)))
convert(::Type{Uint16}, x::Float32) = boxui16(trunc16(fpuiround32(unbox(Float32,x))))
convert(::Type{Uint16}, x::Float64) = boxui16(trunc16(fpuiround64(unbox(Float64,x))))

convert(::Type{Int32}, x::Bool   ) = boxsi32(zext32(unbox(Bool,x)))
convert(::Type{Int32}, x::Int8   ) = boxsi32(sext32(unbox(Int8,x)))
convert(::Type{Int32}, x::Uint8  ) = boxsi32(zext32(unbox(Uint8,x)))
convert(::Type{Int32}, x::Int16  ) = boxsi32(sext32(unbox(Int16,x)))
convert(::Type{Int32}, x::Uint16 ) = boxsi32(zext32(unbox(Uint16,x)))
convert(::Type{Int32}, x::Char   ) = boxsi32(unbox(Int32,x))
convert(::Type{Int32}, x::Uint32 ) = boxsi32(unbox(Uint32,x))
convert(::Type{Int32}, x::Int64  ) = boxsi32(trunc32(unbox(Int64,x)))
convert(::Type{Int32}, x::Uint64 ) = boxsi32(trunc32(unbox(Uint64,x)))
convert(::Type{Int32}, x::Int128 ) = boxsi32(trunc32(unbox(Int128,x)))
convert(::Type{Int32}, x::Uint128) = boxsi32(trunc32(unbox(Uint128,x)))
convert(::Type{Int32}, x::Float32) = boxsi32(fpsiround32(unbox(Int32,x)))
convert(::Type{Int32}, x::Float64) = boxsi32(trunc32(fpsiround64(unbox(Float64,x))))

convert(::Type{Uint32}, x::Bool   ) = boxui32(zext32(unbox(Bool,x)))
convert(::Type{Uint32}, x::Int8   ) = boxui32(sext32(unbox(Int8,x)))
convert(::Type{Uint32}, x::Uint8  ) = boxui32(zext32(unbox(Uint8,x)))
convert(::Type{Uint32}, x::Int16  ) = boxui32(sext32(unbox(Int16,x)))
convert(::Type{Uint32}, x::Uint16 ) = boxui32(zext32(unbox(Uint16,x)))
convert(::Type{Uint32}, x::Char   ) = boxui32(unbox(Uint32,x))
convert(::Type{Uint32}, x::Int32  ) = boxui32(unbox(Uint32,x))
convert(::Type{Uint32}, x::Int64  ) = boxui32(trunc32(unbox(Int64,x)))
convert(::Type{Uint32}, x::Uint64 ) = boxui32(trunc32(unbox(Uint64,x)))
convert(::Type{Uint32}, x::Int128 ) = boxui32(trunc32(unbox(Int128,x)))
convert(::Type{Uint32}, x::Uint128) = boxui32(trunc32(unbox(Uint128,x)))
convert(::Type{Uint32}, x::Float32) = boxui32(fpuiround32(unbox(Uint32,x)))
convert(::Type{Uint32}, x::Float64) = boxui32(trunc32(fpuiround64(unbox(Float64,x))))

convert(::Type{Int64}, x::Bool   ) = boxsi64(zext64(unbox(Bool,x)))
convert(::Type{Int64}, x::Int8   ) = boxsi64(sext64(unbox(Int8,x)))
convert(::Type{Int64}, x::Uint8  ) = boxsi64(zext64(unbox(Uint8,x)))
convert(::Type{Int64}, x::Int16  ) = boxsi64(sext64(unbox(Int16,x)))
convert(::Type{Int64}, x::Uint16 ) = boxsi64(zext64(unbox(Uint16,x)))
convert(::Type{Int64}, x::Char   ) = boxsi64(zext64(unbox(Char,x)))
convert(::Type{Int64}, x::Int32  ) = boxsi64(sext64(unbox(Int32,x)))
convert(::Type{Int64}, x::Uint32 ) = boxsi64(zext64(unbox(Uint32,x)))
convert(::Type{Int64}, x::Uint64 ) = boxsi64(unbox(Uint64,x))
convert(::Type{Int64}, x::Int128 ) = boxsi64(trunc64(unbox(Int128,x)))
convert(::Type{Int64}, x::Uint128) = boxsi64(trunc64(unbox(Uint128,x)))
convert(::Type{Int64}, x::Float32) = boxsi64(fpsiround64(fpext64(unbox(Float32,x))))
convert(::Type{Int64}, x::Float64) = boxsi64(fpsiround64(unbox(Int64,x)))

convert(::Type{Uint64}, x::Bool   ) = boxui64(zext64(unbox(Bool,x)))
convert(::Type{Uint64}, x::Int8   ) = boxui64(sext64(unbox(Int8,x)))
convert(::Type{Uint64}, x::Uint8  ) = boxui64(zext64(unbox(Uint8,x)))
convert(::Type{Uint64}, x::Int16  ) = boxui64(sext64(unbox(Int16,x)))
convert(::Type{Uint64}, x::Uint16 ) = boxui64(zext64(unbox(Uint16,x)))
convert(::Type{Uint64}, x::Char   ) = boxui64(zext64(unbox(Char,x)))
convert(::Type{Uint64}, x::Int32  ) = boxui64(sext64(unbox(Int32,x)))
convert(::Type{Uint64}, x::Uint32 ) = boxui64(zext64(unbox(Uint32,x)))
convert(::Type{Uint64}, x::Int64  ) = boxui64(unbox(Uint64,x))
convert(::Type{Uint64}, x::Int128 ) = boxui64(trunc64(unbox(Int128,x)))
convert(::Type{Uint64}, x::Uint128) = boxui64(trunc64(unbox(Uint128,x)))
convert(::Type{Uint64}, x::Float32) = boxui64(fpuiround64(fpext64(unbox(Float32,x))))
convert(::Type{Uint64}, x::Float64) = boxui64(fpuiround64(unbox(Uint64,x)))
...
-(x::Int)     = boxsint(neg_int(unbox(Int,x)))
-(x::Uint)    = boxuint(neg_int(unbox(Uint,x)))
-(x::Int64)   = boxsi64(neg_int(unbox(Int64,x)))
-(x::Uint64)  = boxui64(neg_int(unbox(Uint64,x)))
-(x::Int128)  = box(Int128,neg_int(unbox(Int128,x)))
-(x::Uint128) = box(Uint128,neg_int(unbox(Uint128,x)))

+(x::Int,     y::Int)     = boxsint(add_int(unbox(Int,x), unbox(Int,y)))
+(x::Uint,    y::Uint)    = boxuint(add_int(unbox(Uint,x), unbox(Uint,y)))
+(x::Int64,   y::Int64)   = boxsi64(add_int(unbox(Int64,x), unbox(Int64,y)))
+(x::Uint64,  y::Uint64)  = boxui64(add_int(unbox(Uint64,x), unbox(Uint64,y)))
...
-(x::Int,     y::Int)     = boxsint(sub_int(unbox(Int,x), unbox(Int,y)))
-(x::Uint,    y::Uint)    = boxuint(sub_int(unbox(Uint,x), unbox(Uint,y)))
-(x::Int64,   y::Int64)   = boxsi64(sub_int(unbox(Int64,x), unbox(Int64,y)))
-(x::Uint64,  y::Uint64)  = boxui64(sub_int(unbox(Uint64,x), unbox(Uint64,y)))
...
*(x::Int,     y::Int)     = boxsint(mul_int(unbox(Int,x), unbox(Int,y)))
*(x::Uint,    y::Uint)    = boxuint(mul_int(unbox(Uint,x), unbox(Uint,y)))
*(x::Int64,   y::Int64)   = boxsi64(mul_int(unbox(Int64,x), unbox(Int64,y)))
*(x::Uint64,  y::Uint64)  = boxui64(mul_int(unbox(Uint64,x), unbox(Uint64,y)))
...
div(x::Int,     y::Int)     = boxsint(sdiv_int(unbox(Int,x), unbox(Int,y)))
div(x::Uint,    y::Uint)    = boxuint(udiv_int(unbox(Uint,x), unbox(Uint,y)))
div(x::Int64,   y::Int64)   = boxsi64(sdiv_int(unbox(Int64,x), unbox(Int64,y)))
div(x::Uint64,  y::Uint64)  = boxui64(udiv_int(unbox(Uint64,x), unbox(Uint64,y)))
...
rem(x::Int,    y::Int)    = boxsint(srem_int(unbox(Int,x), unbox(Int,y)))
rem(x::Uint,   y::Uint)   = boxuint(urem_int(unbox(Uint,x), unbox(Uint,y)))
rem(x::Int64,  y::Int64)  = boxsi64(srem_int(unbox(Int64,x), unbox(Int64,y)))
rem(x::Uint64, y::Uint64) = boxui64(urem_int(unbox(Uint64,x), unbox(Uint64,y)))
...
mod(x::Int,    y::Int)    = boxsint(smod_int(unbox(Int,x), unbox(Int,y)))
mod(x::Int64,  y::Int64)  = boxsi64(smod_int(unbox(Int64,x), unbox(Int64,y)))
mod(x::Int128, y::Int128) = box(Int128,smod_int(unbox(Int128,x), unbox(Int128,y)))

## integer bitwise operations ##

~(x::Int8 ) = boxsi8 (not_int(unbox(Int8,x)))
~(x::Int16) = boxsi16(not_int(unbox(Int16,x)))
~(x::Int32) = boxsi32(not_int(unbox(Int32,x)))
~(x::Int64) = boxsi64(not_int(unbox(Int64,x)))
~(x::Int128) = box(Int128,not_int(unbox(Int128,x)))

~(x::Uint8 ) = boxui8 (not_int(unbox(Uint8,x)))
~(x::Uint16) = boxui16(not_int(unbox(Uint16,x)))
~(x::Uint32) = boxui32(not_int(unbox(Uint32,x)))
~(x::Uint64) = boxui64(not_int(unbox(Uint64,x)))
~(x::Uint128) = box(Uint128,not_int(unbox(Uint128,x)))

(&)(x::Int8 , y::Int8 ) = boxsi8 (and_int(unbox(Int8,x), unbox(Int8,y)))
(&)(x::Int16, y::Int16) = boxsi16(and_int(unbox(Int16,x), unbox(Int16,y)))
(&)(x::Int32, y::Int32) = boxsi32(and_int(unbox(Int32,x), unbox(Int32,y)))
(&)(x::Int64, y::Int64) = boxsi64(and_int(unbox(Int64,x), unbox(Int64,y)))
(&)(x::Int128, y::Int128) = box(Int128,and_int(unbox(Int128,x), unbox(Int128,y)))

(&)(x::Uint8 , y::Uint8 ) = boxui8 (and_int(unbox(Uint8,x), unbox(Uint8,y)))
(&)(x::Uint16, y::Uint16) = boxui16(and_int(unbox(Uint16,x), unbox(Uint16,y)))
(&)(x::Uint32, y::Uint32) = boxui32(and_int(unbox(Uint32,x), unbox(Uint32,y)))
(&)(x::Uint64, y::Uint64) = boxui64(and_int(unbox(Uint64,x), unbox(Uint64,y)))
(&)(x::Uint128, y::Uint128) = box(Uint128,and_int(unbox(Uint128,x), unbox(Uint128,y)))

|(x::Int8 , y::Int8 ) = boxsi8 (or_int(unbox(Int8,x), unbox(Int8,y)))
|(x::Int16, y::Int16) = boxsi16(or_int(unbox(Int16,x), unbox(Int16,y)))
|(x::Int32, y::Int32) = boxsi32(or_int(unbox(Int32,x), unbox(Int32,y)))
|(x::Int64, y::Int64) = boxsi64(or_int(unbox(Int64,x), unbox(Int64,y)))
|(x::Int128, y::Int128) = box(Int128,or_int(unbox(Int128,x), unbox(Int128,y)))

|(x::Uint8 , y::Uint8 ) = boxui8 (or_int(unbox(Uint8,x), unbox(Uint8,y)))
|(x::Uint16, y::Uint16) = boxui16(or_int(unbox(Uint16,x), unbox(Uint16,y)))
|(x::Uint32, y::Uint32) = boxui32(or_int(unbox(Uint32,x), unbox(Uint32,y)))
|(x::Uint64, y::Uint64) = boxui64(or_int(unbox(Uint64,x), unbox(Uint64,y)))
|(x::Uint128, y::Uint128) = box(Uint128,or_int(unbox(Uint128,x), unbox(Uint128,y)))

($)(x::Int8 , y::Int8 ) = boxsi8 (xor_int(unbox(Int8,x), unbox(Int8,y)))
($)(x::Int16, y::Int16) = boxsi16(xor_int(unbox(Int16,x), unbox(Int16,y)))
($)(x::Int32, y::Int32) = boxsi32(xor_int(unbox(Int32,x), unbox(Int32,y)))
($)(x::Int64, y::Int64) = boxsi64(xor_int(unbox(Int64,x), unbox(Int64,y)))
($)(x::Int128, y::Int128) = box(Int128,xor_int(unbox(Int128,x), unbox(Int128,y)))

($)(x::Uint8 , y::Uint8 ) = boxui8 (xor_int(unbox(Uint8,x), unbox(Uint8,y)))
($)(x::Uint16, y::Uint16) = boxui16(xor_int(unbox(Uint16,x), unbox(Uint16,y)))
($)(x::Uint32, y::Uint32) = boxui32(xor_int(unbox(Uint32,x), unbox(Uint32,y)))
($)(x::Uint64, y::Uint64) = boxui64(xor_int(unbox(Uint64,x), unbox(Uint64,y)))
($)(x::Uint128, y::Uint128) = box(Uint128,xor_int(unbox(Uint128,x), unbox(Uint128,y)))

<<(x::Int8 , y::Int32) = boxsi8 (shl_int(unbox(Int8,x), unbox(Int32,y)))
<<(x::Int16, y::Int32) = boxsi16(shl_int(unbox(Int16,x), unbox(Int32,y)))
<<(x::Int32, y::Int32) = boxsi32(shl_int(unbox(Int32,x), unbox(Int32,y)))
<<(x::Int64, y::Int32) = boxsi64(shl_int(unbox(Int64,x), unbox(Int32,y)))
<<(x::Int128, y::Int32) = box(Int128,shl_int(unbox(Int128,x), unbox(Int32,y)))

<<(x::Uint8 , y::Int32) = boxui8 (shl_int(unbox(Uint8,x), unbox(Int32,y)))
<<(x::Uint16, y::Int32) = boxui16(shl_int(unbox(Uint16,x), unbox(Int32,y)))
<<(x::Uint32, y::Int32) = boxui32(shl_int(unbox(Int32,x), unbox(Uint32,y)))
<<(x::Uint64, y::Int32) = boxui64(shl_int(unbox(Uint64,x), unbox(Int32,y)))
<<(x::Uint128, y::Int32) = box(Uint128,shl_int(unbox(Uint128,x), unbox(Int32,y)))

>>(x::Int8 , y::Int32) = boxsi8 (ashr_int(unbox(Int8,x), unbox(Int32,y)))
>>(x::Int16, y::Int32) = boxsi16(ashr_int(unbox(Int16,x), unbox(Int32,y)))
>>(x::Int32, y::Int32) = boxsi32(ashr_int(unbox(Int32,x), unbox(Int32,y)))
>>(x::Int64, y::Int32) = boxsi64(ashr_int(unbox(Int64,x), unbox(Int32,y)))
>>(x::Int128, y::Int32) = box(Int128,ashr_int(unbox(Int128,x), unbox(Int32,y)))

>>(x::Uint8 , y::Int32) = boxui8 (lshr_int(unbox(Uint8,x), unbox(Int32,y)))
>>(x::Uint16, y::Int32) = boxui16(lshr_int(unbox(Uint16,x), unbox(Int32,y)))
>>(x::Uint32, y::Int32) = boxui32(lshr_int(unbox(Int32,x), unbox(Uint32,y)))
>>(x::Uint64, y::Int32) = boxui64(lshr_int(unbox(Uint64,x), unbox(Int32,y)))
>>(x::Uint128, y::Int32) = box(Uint128,lshr_int(unbox(Uint128,x), unbox(Int32,y)))

>>>(x::Int8 , y::Int32) = boxsi8 (lshr_int(unbox(Int8,x), unbox(Int32,y)))
>>>(x::Int16, y::Int32) = boxsi16(lshr_int(unbox(Int16,x), unbox(Int32,y)))
>>>(x::Int32, y::Int32) = boxsi32(lshr_int(unbox(Int32,x), unbox(Int32,y)))
>>>(x::Int64, y::Int32) = boxsi64(lshr_int(unbox(Int64,x), unbox(Int32,y)))
...
bswap(x::Int8)    = x
bswap(x::Uint8)   = x
bswap(x::Int16)   = boxsi16(bswap_int(unbox(Int16,x)))
bswap(x::Uint16)  = boxui16(bswap_int(unbox(Uint16,x)))
bswap(x::Int32)   = boxsi32(bswap_int(unbox(Int32,x)))
bswap(x::Uint32)  = boxui32(bswap_int(unbox(Uint32,x)))
bswap(x::Int64)   = boxsi64(bswap_int(unbox(Int64,x)))
bswap(x::Uint64)  = boxui64(bswap_int(unbox(Uint64,x)))
bswap(x::Int128)  = box(Int128,bswap_int(unbox(Int128,x)))
bswap(x::Uint128) = box(Uint128,bswap_int(unbox(Uint128,x)))

count_ones(x::Int8)    = int(boxsi8 (ctpop_int(unbox(Int8,x))))
count_ones(x::Uint8)   = int(boxui8 (ctpop_int(unbox(Uint8,x))))
count_ones(x::Int16)   = int(boxsi16(ctpop_int(unbox(Int16,x))))
count_ones(x::Uint16)  = int(boxui16(ctpop_int(unbox(Uint16,x))))
count_ones(x::Int32)   = int(boxsi32(ctpop_int(unbox(Int32,x))))
count_ones(x::Uint32)  = int(boxui32(ctpop_int(unbox(Uint32,x))))
count_ones(x::Int64)   = int(boxsi64(ctpop_int(unbox(Int64,x))))
count_ones(x::Uint64)  = int(boxui64(ctpop_int(unbox(Uint64,x))))
...
leading_zeros(x::Int8)    = int(boxsi8 (ctlz_int(unbox(Int8,x))))
leading_zeros(x::Uint8)   = int(boxui8 (ctlz_int(unbox(Uint8,x))))
leading_zeros(x::Int16)   = int(boxsi16(ctlz_int(unbox(Int16,x))))
leading_zeros(x::Uint16)  = int(boxui16(ctlz_int(unbox(Uint16,x))))
leading_zeros(x::Int32)   = int(boxsi32(ctlz_int(unbox(Int32,x))))
leading_zeros(x::Uint32)  = int(boxui32(ctlz_int(unbox(Uint32,x))))
leading_zeros(x::Int64)   = int(boxsi64(ctlz_int(unbox(Int64,x))))
leading_zeros(x::Uint64)  = int(boxui64(ctlz_int(unbox(Uint64,x))))
...
trailing_zeros(x::Int8)    = int(boxsi8 (cttz_int(unbox(Int8,x))))
trailing_zeros(x::Uint8)   = int(boxui8 (cttz_int(unbox(Uint8,x))))
trailing_zeros(x::Int16)   = int(boxsi16(cttz_int(unbox(Int16,x))))
trailing_zeros(x::Uint16)  = int(boxui16(cttz_int(unbox(Uint16,x))))
trailing_zeros(x::Int32)   = int(boxsi32(cttz_int(unbox(Int32,x))))
trailing_zeros(x::Uint32)  = int(boxui32(cttz_int(unbox(Uint32,x))))
trailing_zeros(x::Int64)   = int(boxsi64(cttz_int(unbox(Int64,x))))
trailing_zeros(x::Uint64)  = int(boxui64(cttz_int(unbox(Uint64,x))))
