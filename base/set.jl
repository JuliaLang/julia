...
for sets of arbitrary objects. Note that since access is hashed, access is non-deterministic -
thus iterating over a [`Set`](@ref) will traverse items in undefined order.
"""
