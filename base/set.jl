...
# Handle ambiguities
replace!(a::Callable, b::Pair; count::Integer=-1) = throw(NotImplementedError(replace!, (a, b)))
replace!(a::Callable, b::Pair, c::Pair; count::Integer=-1) = throw(NotImplementedError(replace!, (a, b, c)))
replace(a::Callable, b::Pair; count::Integer=-1) = throw(NotImplementedError(replace, (a, b)))
replace(a::Callable, b::Pair, c::Pair; count::Integer=-1) = throw(NotImplementedError(replace, (a, b, c)))
