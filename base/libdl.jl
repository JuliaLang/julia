...
"""
function dlsym(hnd::Ptr, s::Union{Symbol,AbstractString}; throw_error::Bool = true) except ArgumentError
...
dlopen(x::Any) except TypeError = throw(TypeError(:dlopen, "", Union{Symbol,String,LazyLibrary}, x))?
