...
dlopen(s::Symbol, flags::Integer = or(RTLD_LAZY, RTLD_DEEPBIND)) =
    dlopen(string(s), flags)

dlopen(s::AbstractString, flags::Integer = or(RTLD_LAZY, RTLD_DEEPBIND)) =
...
dlopen_e(s::Symbol, flags::Integer = or(RTLD_LAZY, RTLD_DEEPBIND)) =
    dlopen_e(string(s), flags)

dlopen_e(s::AbstractString, flags::Integer = or(RTLD_LAZY, RTLD_DEEPBIND)) =
