...
```jldoctest
julia> UDict([("A", 1), ("B", 2)])
UDict{String, Int64} with 2 entries:
  "B" => 2
  "A" => 1
```
...
julia> d
UDict{String, Int64} with 4 entries:
  "c" => 3
  "b" => 2
  "a" => 1
  "d" => 4
...
julia> squares
UDict{Int64, Int64} with 1 entry:
  2 => 4
```
"""
get!(f::Function, collection, key)
...
# Examples
```jldoctest
julia> D = UDict('a'=>2, 'b'=>3)
UDict{Char, Int64} with 2 entries:
  'a' => 2
  'b' => 3
...
julia> delete!(d, "b")
UDict{String, Int64} with 1 entry:
  "a" => 1
