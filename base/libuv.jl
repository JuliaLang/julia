...
function reinit_stdio()
    global uv_jl_alloc_buf     = cfunction(uv_alloc_buf, Void, Tuple{Ptr{Cvoid}, Csize_t, Ptr{Cvoid}})
    global uv_jl_readcb        = cfunction(uv_readcb, Void, Tuple{Ptr{Cvoid}, Cssize_t, Ptr{Cvoid}})
    global uv_jl_connectioncb  = cfunction(uv_connectioncb, Void, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_connectcb     = cfunction(uv_connectcb, Void, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_writecb_task  = cfunction(uv_writecb_task, Void, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_getaddrinfocb = cfunction(uv_getaddrinfocb, Void, Tuple{Ptr{Cvoid}, Cint, Ptr{Cvoid}})
    global uv_jl_getnameinfocb = cfunction(uv_getnameinfocb, Void, Tuple{Ptr{Cvoid}, Cint, Cstring, Cstring})
    global uv_jl_recvcb        = cfunction(uv_recvcb, Void, Tuple{Ptr{Cvoid}, Cssize_t, Ptr{Cvoid}, Ptr{Cvoid}, Cuint})
    global uv_jl_sendcb        = cfunction(uv_sendcb, Void, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_return_spawn  = cfunction(uv_return_spawn, Void, Tuple{Ptr{Cvoid}, Int64, Int32})
    global uv_jl_asynccb       = cfunction(uv_asynccb, Void, Tuple{Ptr{Cvoid}})
    global uv_jl_timercb       = cfunction(uv_timercb, Void, Tuple{Ptr{Cvoid}})
