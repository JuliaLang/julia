...
function reinit_stdio()
    global uv_jl_alloc_buf     = cfunction(uv_alloc_buf, Nothing, Tuple{Ptr{Cvoid}, Csize_t, Ptr{Cvoid}})
    global uv_jl_readcb        = cfunction(uv_readcb, Nothing, Tuple{Ptr{Cvoid}, Cssize_t, Ptr{Cvoid}})
    global uv_jl_connectioncb  = cfunction(uv_connectioncb, Nothing, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_connectcb     = cfunction(uv_connectcb, Nothing, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_writecb_task  = cfunction(uv_writecb_task, Nothing, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_getaddrinfocb = cfunction(uv_getaddrinfocb, Nothing, Tuple{Ptr{Cvoid}, Cint, Ptr{Cvoid}})
    global uv_jl_getnameinfocb = cfunction(uv_getnameinfocb, Nothing, Tuple{Ptr{Cvoid}, Cint, Cstring, Cstring})
    global uv_jl_recvcb        = cfunction(uv_recvcb, Nothing, Tuple{Ptr{Cvoid}, Cssize_t, Ptr{Cvoid}, Ptr{Cvoid}, Cuint})
    global uv_jl_sendcb        = cfunction(uv_sendcb, Nothing, Tuple{Ptr{Cvoid}, Cint})
    global uv_jl_return_spawn  = cfunction(uv_return_spawn, Nothing, Tuple{Ptr{Cvoid}, Int64, Int32})
    global uv_jl_asynccb       = cfunction(uv_asynccb, Nothing, Tuple{Ptr{Cvoid}})
    global uv_jl_timercb       = cfunction(uv_timercb, Nothing, Tuple{Ptr{Cvoid}})
