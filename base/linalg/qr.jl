...
Base.propertynames(F::Union{QR,QRCompactWY}, private::Bool=false) = append!([:R,:Q], private ? Symbol[] : fieldnames(typeof(F)))
...
Base.propertynames(F::QRPivoted, private::Bool=false) = append!([:R,:Q,:p,:P], private ? Symbol[] : fieldnames(typeof(F)))
