...
eigensolvers, but may be converted into a regular matrix with [`Array(_)`](:func:`convert`).
"""
...
solvers, but may be converted into a regular matrix with [`Array(_)`](:func:`convert`).
