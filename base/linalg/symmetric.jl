...
getindex(b::BoundsCheckOff, A::Symmetric, i::Integer, j::Integer) = (A.uplo == 'U') == (i < j) ? getindex(b, A.data, i, j) : getindex(b, A.data, j, i)
getindex(b::BoundsCheckOff, A::Hermitian, i::Integer, j::Integer) = (A.uplo == 'U') == (i < j) ? getindex(b, A.data, i, j) : conj(getindex(b, A.data, j, i))
