...
function Triangular{T,UpLo,UnitDiagonal}(A::AbstractMatrix{T}, ::Type{€{UpLo}}, ::Type{€{UnitDiagonal}})
    chksquare(A)
    Triangular{T,typeof(A),UpLo,UnitDiagonal}(A)
end
function Triangular{T,UpLo}(A::AbstractMatrix{T}, ::Type{€{UpLo}})
    chksquare(A)
