...
(E"General Collections",
 E"isempty",
 E"isempty(collection)
...
(E"Indexable Collections",
 E"collection[key...]",
 E"ref(collection, key...)
collection[key...]
...
(E"Indexable Collections",
 E"collection[key...] = value",
 E"assign(collection, value, key...)
...
(E"Associative Collections",
 E"del_all",
 E"del_all(collection)

   Delete all keys from a collection.

"),

(E"Set-Like Collections",
 E"add",
 E"add(collection, key)
...
(E"Dequeues",
 E"insert",
 E"insert(collection, index, item)
...
(E"Strings",
 E"split",
 E"split(string, char, include_empty)
...
(E"I/O",
 E"open",
 E"open(file_name[, read, write, create, truncate, append])
...
(E"Text I/O",
 E"dlmread",
 E"dlmread(filename, delim::Char, T::Type)
...
(E"Text I/O",
 E"dlmwrite",
 E"dlmwrite(filename, array, delim::Char)
...
(E"Memory-mapped I/O",
 E"mmap_array",
 E"mmap_array(type, dims, stream[, offset])
...
(E"Memory-mapped I/O",
 E"mmap",
 E"mmap(len, prot, flags, fd, offset)
...
(E"Random Numbers",
 E"randi",
 E"randi(Int32|Uint32|Int64|Uint64)
...
(E"Arrays",
 E"similar",
 E"similar(array, element_type, dims)
...
(E"Parallel Computing",
 E"remote_call_wait",
 E"remote_call_wait(id, func, args...)
...
(E"Parallel Computing",
 E"remote_call_fetch",
 E"remote_call_fetch(id, func, args...)
...
(E"Distributed Arrays",
 E"darray",
 E"darray(init, type, dims[, distdim, procs, dist])
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_create_file",
 E"fits_create_file(filename::String)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_clobber_file",
 E"fits_clobber_file(filename::String)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_open_file",
 E"fits_open_file(filename::String)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_get_hdrspace",
 E"fits_get_hdrspace(f::FITSFile) -> (keysexist, morekeys)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_read_keyword",
 E"fits_read_keyword(f::FITSFile, keyname::String) -> (value, comment)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_read_record",
 E"fits_read_record(f::FITSFile, keynum::Int) -> String
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_read_keyn",
 E"fits_read_keyn(f::FITSFile, keynum::Int) -> (name, value, comment)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_write_key",
 E"fits_write_key(f::FITSFile, keyname::String, value, comment::String)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_write_record",
 E"fits_write_record(f::FITSFile, card::String)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_delete_record",
 E"fits_delete_record(f::FITSFile, keynum::Int)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_delete_key",
 E"fits_delete_key(f::FITSFile, keyname::String)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_get_img_size",
 E"fits_get_img_size(f::FITSFile)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_create_img",
 E"fits_create_img(f::FITSFile, t::Type, naxes::Vector{Int})
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_write_pix",
 E"fits_write_pix(f::FITSFile, fpixel::Vector{Int}, nelements::Int, data::Array)
...
(E"fitsio.jl --- FITS File I/O",
 E"fits_read_pix",
 E"fits_read_pix(f::FITSFile, fpixel::Vector{Int}, nelements::Int, data::Array)

   Read pixels from the FITS file into 'data'.

"),

(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_prob_name",
 E"glp_set_prob_name(glp_prob, name)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_obj_name",
 E"glp_set_obj_name(glp_prob, name)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_obj_dir",
 E"glp_set_obj_dir(glp_prob, dir)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_row_name",
 E"glp_set_row_name(glp_prob, row, name)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_col_name",
 E"glp_set_col_name(glp_prob, col, name)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_row_bnds",
 E"glp_set_row_bnds(glp_prob, row, bounds_type, lb, ub)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_col_bnds",
 E"glp_set_col_bnds(glp_prob, col, bounds_type, lb, ub)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_obj_coef",
 E"glp_set_obj_coef(glp_prob, col, coef)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_mat_row",
 E"glp_set_mat_row(glp_prob, row[, len], ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_mat_col",
 E"glp_set_mat_col(glp_prob, col[, len], ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_load_matrix",
 E"glp_load_matrix(glp_prob[, numel], ia, ja, ar)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_check_dup",
 E"glp_check_dup(rows, cols[, numel], ia, ja)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_del_rows",
 E"glp_del_rows(glp_prob[, num_rows], rows_ids)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_del_cols",
 E"glp_del_cols(glp_prob, cols_ids)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_copy_prob",
 E"glp_copy_prob(glp_prob_dest, glp_prob, copy_names)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_row_name",
 E"glp_get_row_name(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_col_name",
 E"glp_get_col_name(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_row_type",
 E"glp_get_row_type(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_col_type",
 E"glp_get_col_type(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_obj_coef",
 E"glp_get_obj_coef(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_mat_row",
 E"glp_get_mat_row(glp_prob, row, ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_mat_col",
 E"glp_get_mat_col(glp_prob, col, ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_rii",
 E"glp_set_rii(glp_prob, row, rii)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_sjj",
 E"glp_set_sjj(glp_prob, col, sjj)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_scale_prob",
 E"glp_scale_prob(glp_prob, flags)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_row_stat",
 E"glp_set_row_stat(glp_prob, row, stat)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_col_stat",
 E"glp_set_col_stat(glp_prob, col, stat)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_adv_basis",
 E"glp_adv_basis(glp_prob[, flags])
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_simplex",
 E"glp_simplex(glp_prob[, glp_param])
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_exact",
 E"glp_exact(glp_prob[, glp_param])
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_row_stat",
 E"glp_get_row_stat(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_row_prim",
 E"glp_get_row_prim(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_row_dual",
 E"glp_get_row_dual(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_col_stat",
 E"glp_get_col_stat(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_col_prim",
 E"glp_get_col_prim(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_col_dual",
 E"glp_get_col_dual(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_interior",
 E"glp_interior(glp_prob[, glp_param])
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_ipt_row_prim",
 E"glp_ipt_row_prim(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_ipt_row_dual",
 E"glp_ipt_row_dual(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_ipt_col_prim",
 E"glp_ipt_col_prim(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_ipt_col_dual",
 E"glp_ipt_col_dual(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_col_kind",
 E"glp_set_col_kind(glp_prob, col, kind)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_col_kind",
 E"glp_get_col_kind(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_intopt",
 E"glp_intopt(glp_prob[, glp_param])
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_mip_row_val",
 E"glp_mip_row_val(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_mip_col_val",
 E"glp_mip_col_val(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_read_mps",
 E"glp_read_mps(glp_prob, format[, param], filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_write_mps",
 E"glp_write_mps(glp_prob, format[, param], filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_read_lp",
 E"glp_read_lp(glp_prob[, param], filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_write_lp",
 E"glp_write_lp(glp_prob[, param], filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_read_prob",
 E"glp_read_prob(glp_prob[, flags], filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_write_prob",
 E"glp_write_prob(glp_prob[, flags], filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_mpl_read_model",
 E"glp_mpl_read_model(glp_tran, filename, skip)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_mpl_read_data",
 E"glp_mpl_read_data(glp_tran, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_mpl_generate",
 E"glp_mpl_generate(glp_tran[, filename])
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_mpl_build_prob",
 E"glp_mpl_build_prob(glp_tran, glp_prob)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_mpl_postsolve",
 E"glp_mpl_postsolve(glp_tran, glp_prob, sol)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_print_sol",
 E"glp_print_sol(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_read_sol",
 E"glp_read_sol(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_write_sol",
 E"glp_write_sol(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_print_ipt",
 E"glp_print_ipt(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_read_ipt",
 E"glp_read_ipt(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_write_ipt",
 E"glp_write_ipt(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_print_mip",
 E"glp_print_mip(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_read_mip",
 E"glp_read_mip(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_write_mip",
 E"glp_write_mip(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_print_ranges",
 E"glp_print_ranges(glp_prob, [[len,] list,] [flags,] filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_bfcp",
 E"glp_get_bfcp(glp_prob, glp_param)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_set_bfcp",
 E"glp_set_bfcp(glp_prob[, glp_param])
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_row_bind",
 E"glp_get_row_bind(glp_prob, row)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_get_col_bind",
 E"glp_get_col_bind(glp_prob, col)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_eval_tab_row",
 E"glp_eval_tab_row(glp_prob, k, ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_eval_tab_col",
 E"glp_eval_tab_col(glp_prob, k, ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_transform_row",
 E"glp_transform_row(glp_prob[, len], ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_transform_col",
 E"glp_transform_col(glp_prob[, len], ind, val)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_prim_rtest",
 E"glp_prim_rtest(glp_prob[, len], ind, val, dir, eps)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_dual_rtest",
 E"glp_dual_rtest(glp_prob[, len], ind, val, dir, eps)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_analyze_bound",
 E"glp_analyze_bound(glp_prob, k)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_sdf_close_file",
 E"glp_sdf_close_file(glp_data)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_read_cnfsat",
 E"glp_read_cnfsat(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_write_cnfsat",
 E"glp_write_cnfsat(glp_prob, filename)
...
(E"glpk.jl --- Wrapper for the GNU Linear Programming Kit (GLPK)",
 E"glp_intfeas1",
 E"glp_intfeas1(glp_prob, use_bound, obj_bound)
...
(E"options.jl --- Optional arguments to functions",
 E"options",
 E"options()
...
(E"options.jl --- Optional arguments to functions",
 E"check_lock",
 E"class class Options(OptionsChecking, param1, val1, param2, val2, ...)
...
(E"profile.jl --- A simple profiler for Julia",
 E"profile",
 E"profile()
...
(E"specfun.jl --- Special mathematical functions",
 E"airyai",
 E"airy(x)
airyai(x)
