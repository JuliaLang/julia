...
\begin{verbatim}
  ...
  'B'
\end{verbatim}
For performance, the \verb|char| conversion does not check that the character value is a valid Unicode code point.
If you want to check for valid code points, use the \verb|safe_char| conversion instead:
\begin{verbatim}
  julia> char(0x110000)
  '\U00110000'
...
In Julia, bare string literals always produce one of two types of strings:
...
Here is the most basic string literal example:
\begin{verbatim}
  julia> "hello, world"
  "hello, world"
\end{verbatim}
...
The \verb|Latin1String| and \verb|UTF8String| classes are both thin wrappers around an array of bytes (\verb|Uint8| values), holding the .
