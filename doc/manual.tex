...
Worse still, some bytes are not the beginning of a character at all---they're right in the middle of a character.
This is called a ``continuation character.''
Fortunately, both UTF-8 and UTF-16 are carefully designed so that you can immediately tell which category the byte at an index falls into.
