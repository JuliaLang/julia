...
Matlab is quite effective for prototyping and exploring numerical linear algebra, but it has some limitations for programming tasks outside of this relatively narrow scope.
