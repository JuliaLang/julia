...
Thus, the \verb|Char| type is the basic building block of all strings.
Typically, (but not necessarily), indices correspond to byte offsets into some underlying encoding of a string.

In Julia, standard string literals always produce one of two types of strings:
