...
\begin{verbatim}
  ...
  1//3
\end{verbatim}
This normalized form for a ratio of integers is unique, so equality of rational values can be checked by testing for equality of the numerator and denominator.
...
\begin{verbatim}
  ...
  3
\end{verbatim}
Direct comparison of the numerator and denominator is not usually necessary, since the standard arithmetic and comparison operations are defined for rational values:
\begin{verbatim}
  julia> 2//3 == 6//9
  true
...
\begin{verbatim}
  ...
  0.75
\end{verbatim}
All such conversions obey the following identity for any integral values, \verb|a| and \verb|b|:
\begin{verbatim}
