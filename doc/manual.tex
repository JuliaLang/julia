...
\end{tikzpicture}
\end{center}
The bottom row of types are concrete bits types, while the types above are all abstract types, dividing and subdividing the concrete types into convenient subsets.
This diagram is incomplete:
there are other subtypes of both \verb|Number| and \verb|Real|.
These are, however, all the numeric bits types in Julia.
