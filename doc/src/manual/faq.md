...
or [`typemax(Int)`](@ref) as appropriate. This expands each integer operation from a single
instruction to into a few instruction. But it gets worse – saturating integer arithmetic isn't 
