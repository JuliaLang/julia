...
| `is_ptr_loadable(A)`                               |     `false`                            | Return `true` to indicate the element pointer can be used to load elements. |
| `is_ptr_storeable(A)`                              |     `false`                            | Return `true` to indicate the element pointer can be used to store elements. |
