...
|:----------------------------- |:------------------------------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `mutable struct`              | `String`                                    | "Concrete Type" :: A group of related data that includes a type-tag, is managed by the Julia GC, and is defined by object-identity. The type parameters of a concrete type must be fully defined (no `TypeVars` are allowed) in order for the instance to be constructed.              |
...
For translating a C argument list to Julia:
  ...
  * `struct T` (including typedef to a struct)
      ...
      * `T`, where `T` is a Julia concrete type
      * argument value will be copied (passed by value)
  * `void*`
