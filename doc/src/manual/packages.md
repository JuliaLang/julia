...
```julia-repl
julia> Pkg.status()
INFO: Initializing package repository /Users/johndoe/.julia/v0.6
...
INFO: Initializing FooBar repo: /Users/johndoe/.julia/v0.6/FooBar
INFO: Origin: git://github.com/johndoe/FooBar.jl.git
...
```
git://github.com/johndoe/FooBar.jl.git
```
...
```julia-repl
julia> Pkg.clone("git://github.com/johndoe/FooBar.jl.git")
INFO: Cloning FooBar from git@github.com:johndoe/FooBar.jl.git
```
...
INFO: Registering FooBar at git://github.com/johndoe/FooBar.jl.git
...
INFO: Forking JuliaLang/METADATA.jl to johndoe
INFO: Pushing changes as branch pull-request/ef45f54b
INFO: To create a pull-request open:

  https://github.com/johndoe/METADATA.jl/compare/pull-request/ef45f54b
```
...
INFO: To create a pull-request open:
  ...
  https://github.com/johndoe/METADATA.jl/compare/pull-request/3ef4f5c4
```
