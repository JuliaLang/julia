...
| `_`         | underscores may be assigned values which will not be saved; often used to ignore [multiple return values](@ref Destructuring-Assignment-and-Multiple-Return-Values) or create repetitive [comprehensions](@ref Comprehensions) |
