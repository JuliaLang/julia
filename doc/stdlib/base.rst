...
.. function:: rms(s)
    ...
    Computes the root-mean-square of the vector ``s``.

.. function:: rms(s1, s2[, norma])

    Computes the root-mean-square of the vector ``s1-s2``. Setting ``norma``
    to 1, normalises the root-mean-square w.r.t. the range of ``s2``.
