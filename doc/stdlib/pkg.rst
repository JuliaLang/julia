...
.. function:: generate(pkg, license)
   ...
   Generate a new package named "pkg" with one of these license keys: ""MIT"", ""BSD"" or ""ASL"". If you want to make a package with a different license, you can edit it afterwards. Generate creates a git repo at "Pkg.dir(pkg)" for the package and inside it "LICENSE.md", "README.md", the julia entrypoint "$pkg/src/$pkg.jl", and a travis test file, ".travis.yml".
