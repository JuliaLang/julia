...
A full suite of parsing and formatting tests and examples is available in `tests/dates/io.jl <https://github.com/JuliaLang/julia/blob/release-0.5/test/dates/io.jl>`_.
...
Additional examples and tests are available in `test/dates/adjusters.jl <https://github.com/JuliaLang/julia/blob/release-0.5/test/dates/adjusters.jl>`_.
