...
other languages), but then the result would not be :ref:`man-type-stable`
and the :func:`sqrt` function would have poor
performance.
...
this would cause every computation involving integers to be type-unstable.
Writing :ref:`man-type-stable` code is crucial for effective
