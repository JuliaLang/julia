...
- Julia does not automatically grow arrays in an assignment statement.
  ...
  Julia has :func:`push!` and :func:`append!`, which `geometrically expand <https://en.wikipedia.org/wiki/Dynamic_array#Geometric_expansion_and_amortized_cost>`_ :obj:`Vector`\ s
