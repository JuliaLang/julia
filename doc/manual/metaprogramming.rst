...
interpolation is intentionally reminiscent of `string
interpolation <../strings#Interpolation>`_ and `command
interpolation <../running-external-programs#Interpolation>`_. Expression
interpolation allows convenient, readable programmatic construction of
...
Recall from `Strings <../strings#Non+Standard+String+Literals>`_ that
