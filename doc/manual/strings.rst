...
-  :obj:`String` is an abstraction, not a concrete type — many different
   representations can implement the :obj:`String` interface, but they can
   easily be used together and interact transparently. Any string type
   can be used in any function expecting a :obj:`String`.
...
-  As in Java, strings are immutable: the value of a :obj:`String` object
...
:obj:`String` literals are delimited by double quotes or triple double quotes:
...
Using an index less than 1 or greater than ``end`` raises an error::
    ...
    julia> str[0]
    ERROR: BoundsError()
     in getindex at /Users/sabae/src/julia-0.3/usr/lib/julia/sys.dylib (repeats 2 times)
...
:func:`string` is the identity for :obj:`String` and :obj:`Char`
