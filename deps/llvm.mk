...
ifeq ($(OS),wasm)
LLVM_CMAKE += -DCROSS_TOOLCHAIN_FLAGS_NATIVE=-DCMAKE_TOOLCHAIN_FILE=$(SRCDIR)/NATIVE.cmake -DCMAKE_CROSSCOMPILING=True -DLLVM_INCLUDE_UTILS=False -DLLVM_INSTALL_UTILS=False -DHAVE_HISTEDIT_H=Off -DHAVE_LIBEDIT=Off -DLLVM_BUILD_LLVM_DYLIB:BOOL=ON -DLLVM_LINK_LLVM_DYLIB:BOOL=ON -DLLVM_ENABLE_THREADS=OFF -DLLVM_INCLUDE_TESTS=OFF
endif
