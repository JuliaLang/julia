...
$(BUILDDIR)/$(OPENBLAS_SRC_DIR)/openblas-fix-initialization-to-zero-in-the-NEON-SGEMM_BETA-ke.patch-applied: $(BUILDDIR)/$(OPENBLAS_SRC_DIR)/source-extracted
	cd $(BUILDDIR)/$(OPENBLAS_SRC_DIR) && \
		patch -p1 -f < $(SRCDIR)/patches/openblas-fix-initialization-to-zero-in-the-NEON-SGEMM_BETA-ke.patch
	echo 1 > $@

$(BUILDDIR)/$(OPENBLAS_SRC_DIR)/openblas-winexit.patch-applied: $(BUILDDIR)/$(OPENBLAS_SRC_DIR)/openblas-fix-initialization-to-zero-in-the-NEON-SGEMM_BETA-ke.patch-applied
	cd $(BUILDDIR)/$(OPENBLAS_SRC_DIR) && \
