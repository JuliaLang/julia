...
$(LIBSSH2_SRC_PATH)/libssh2-fix-import-lib-name.patch: $(LIBSSH2_SRC_PATH)/libssh2-userauth-check.patch-applied
	cd $(LIBSSH2_SRC_PATH) && \
		patch -p1 -f < $(SRCDIR)/patches/libssh2-fix-import-lib-name.patch
	echo 1 > $@

$(BUILDDIR)/$(LIBSSH2_SRC_DIR)/build-configured: \
	$(LIBSSH2_SRC_PATH)/libssh2-fix-import-lib-name.patch
